...
!function () {
    ...
    function M(t) {
        ...
        for (n in i = Array.isArray(h) ? [] : {}, h) h.hasOwnProperty(n) && (s = h[n], i[n] = s && "object" == typeof s ? M(s) : s);
        return i
    }
    ...
    var g = function () {
        ...
        return r(i, t), i.prototype._ = function (t) {
            ...
            if (null !== this.v && null !== this.v.M) {
                var i = this.v.M, n = this.v, s = function (s) {
                    t.beginPath();
    ...
    var C = {from: 0, to: 1}, x = function () {
        function t(t, i) {
            this.T = new g, this.A = [], this.B = [], this.L = !0, this.F = t, this.V = i, this.T.i(this.A)
        }

        return t.prototype.O = function (t) {
            var i = this.F.P();
            i.length !== this.A.length && (this.B = i.map(k), this.A = this.B.map((function (t) {
                var i = new y;
                return i._(t), i
            })), this.T.i(this.A)), this.L = !0
        }, t.prototype.W = function (t, i, n) {
            return this.L && (this.R(t), this.L = !1), this.T
        }, t.prototype.R = function (t) {
            var i = this, n = this.F.P(), s = this.V.I(), h = this.F.j();
            n.forEach((function (n, r) {
                var e, u = i.B[r], a = n.q(s);
                if (null !== a && n.U()) {
                    var o = l(n.H());
                    u.N = a.Y, u.C = a.C, u.m[0].D = a.D, u.m[0].p = n.$().K(a.D, o.X), u.k = null !== (e = a.Z) && void 0 !== e ? e : i.F.J(u.m[0].p / t), u.m[0].S = s, u.m[0].g = h.G(s), u.M = C
                } else u.M = null
            }))
        }, t
    }(), N = function () {
        ...
        return t.prototype.h = function (t, i, h, r) {
            if (null !== this.tt) {
                var e = this.tt.it.U, u = this.tt.nt.U;
                if (e || u) {
                    t.save();
                    var a = Math.round(this.tt.g * i), o = Math.round(this.tt.p * i), l = Math.ceil(this.tt.st * i),
                        f = Math.ceil(this.tt.ht * i);
                    t.lineCap = "butt", e && a >= 0 && (t.lineWidth = Math.floor(this.tt.it.rt * i), t.strokeStyle = this.tt.it.et, t.fillStyle = this.tt.it.et, n(t, this.tt.it.ut), function (t, i, n, s) {
                        t.beginPath();
                        var h = t.lineWidth % 2 ? .5 : 0;
                        t.moveTo(i + h, n), t.lineTo(i + h, s), t.stroke()
                    }(t, a, 0, f)), u && o >= 0 && (t.lineWidth = Math.floor(this.tt.nt.rt * i), t.strokeStyle = this.tt.nt.et, t.fillStyle = this.tt.nt.et, n(t, this.tt.nt.ut), s(t, o, 0, l)), t.restore()
                }
            }
        }, t
    }(), S = function () {
        function t(t) {
            this.L = !0, this.at = {
                ...
                g: 0,
                p: 0
            }, this.ot = new N(this.at), this.lt = t
        }
        ...
        return t.prototype.O = function () {
            ...
            var t = this.lt.U(), i = l(this.lt.ft()), n = i.vt().ct().crosshair, s = this.at;
            s.nt.U = t && this.lt._t(i), s.it.U = t && this.lt.dt(), s.nt.rt = n.horzLine.width, s.nt.ut = n.horzLine.style, s.nt.et = n.horzLine.color, s.it.rt = n.vertLine.width, s.it.ut = n.vertLine.style, s.it.et = n.vertLine.color, s.st = i.wt(), s.ht = i.Mt(), s.g = this.lt.bt(), s.p = this.lt.gt()
        }, t
    }(), D = {
        khaki: "#f0e68c",
        azure: "#f0ffff",
    ...
    function V(t) {
        var i;
        if ((t = t.toLowerCase()) in D && (t = D[t]), i = F.exec(t) || E.exec(t)) return [T(parseInt(i[1], 10)), T(parseInt(i[2], 10)), T(parseInt(i[3], 10)), A(i.length < 5 ? 1 : parseFloat(i[4]))];
        if (i = L.exec(t)) return [T(parseInt(i[1], 16)), T(parseInt(i[2], 16)), T(parseInt(i[3], 16)), 1];
        if (i = B.exec(t)) return [T(17 * parseInt(i[1], 16)), T(17 * parseInt(i[2], 16)), T(17 * parseInt(i[3], 16)), 1];
    ...
    var I, j = function () {
        ...
        return t.prototype._ = function (t, i) {
            ...
            if (this.tt.U) {
                t.font = i.xt;
                var e = this.tt.Nt || !this.tt.St ? i.Dt : 0, u = i.Tt, a = i.At, o = i.Bt, l = i.Lt, f = i.Et,
                    c = this.tt.Ft, v = Math.ceil(n.Vt(t, c)), _ = i.Ot, d = i.Pt + a + o, w = Math.ceil(.5 * d),
                    M = u + v + l + f + e, b = this.Ct.Wt;
                this.Ct.zt && (b = this.Ct.zt);
                var m, g, p = (b = Math.round(b)) - w, y = p + d, k = "right" === h, C = k ? s : 0,
                    x = Math.ceil(s * r), N = C;
                if (t.fillStyle = this.Ct.yt, t.lineWidth = 1, t.lineCap = "butt", c) {
                    k ? (m = C - e, g = (N = C - M) + f) : (N = C + M, m = C + e, g = C + u + e + l);
                    var S = Math.max(1, Math.floor(r)), D = Math.max(1, Math.floor(u * r)), T = k ? x : 0,
                        A = Math.round(p * r), B = Math.round(N * r), L = Math.round(b * r) - Math.floor(.5 * r),
                        E = L + S + (L - A), F = Math.round(m * r);
                    t.save(), t.beginPath(), t.moveTo(T, A), t.lineTo(B, A), t.lineTo(B, E), t.lineTo(T, E), t.fill(), t.fillStyle = this.tt.Z, t.fillRect(k ? x - D : 0, A, D, E - A), this.tt.Nt && (t.fillStyle = this.Ct.et, t.fillRect(T, L, F - T, S)), t.textAlign = "left", t.fillStyle = this.Ct.et, W(t, r, (function () {
        ...
        function t(t) {
            this.Rt = {Wt: 0, et: "#FFF", yt: "#000"}, this.It = {
                Ft: "",
                U: !1,
                Nt: !0,
                St: !1,
                ...
                St: !0,
                Z: ""
            }, this.L = !0, this.qt = new (t || j)(this.It, this.Rt), this.Ut = new (t || j)(this.jt, this.Rt)
        }
        ...
        return t.prototype.Ft = function () {
            ...
            return void 0 === i && (i = !1), Math.max(this.qt.Mt(t, i), this.Ut.Mt(t, i))
            ...
            return this.Ht(), this.It.Nt = this.It.Nt && t.ct().drawTicks, this.jt.Nt = this.jt.Nt && t.ct().drawTicks, this.qt._(this.It, this.Rt), this.Ut._(this.jt, this.Rt), this.qt
        }, t.prototype.Zt = function () {
            return this.Ht(), this.qt._(this.It, this.Rt), this.Ut._(this.jt, this.Rt), this.Ut
        }, t.prototype.Ht = function () {
            this.L && (this.It.Nt = !0, this.jt.Nt = !1, this.Jt(this.It, this.jt, this.Rt))
        }, t
    }(), U = function (t) {
        function i(i, n, s) {
        ...
        return r(i, t), i.prototype.Jt = function (t, i, n) {
            t.U = !1;
        ...
        function t(t, i, n) {
            this.L = !0, this.ot = new Y, this.at = {
                U: !1,
                yt: "#4c525e",
                et: "white",
                Ft: "",
    ...
    var X = function (t) {
        function i(i, n) {
            ...
            s.vi = null, s._i = NaN, s.di = 0, s.wi = !0, s.Mi = new Map, s.bi = !1, s.mi = NaN, s.gi = NaN, s.pi = NaN, s.yi = NaN, s.hi = i, s.ki = n, s.Ci = new x(i, s);
            var h, r;
            s.xi = (h = function () {
                return s._i
            }, r = function () {
        ...
        return r(i, t), i.prototype.ct = function () {
            ...
            this.wi = !1, this.Pi(), this._i = NaN, this.mi = NaN, this.gi = NaN, this.vi = null, this.Bi()
            ...
            this.Ti.O(), this.Mi.forEach((function (t) {
                return t.O()
            })), this.Di.O(), this.Ci.O()
            ...
            var s = this.mi, h = this.gi, r = this._i, e = this.di, u = this.vi, a = this.ji(n);
            this.di = t, this.mi = isNaN(t) ? NaN : this.hi.j().G(t), this.vi = n;
            var o = null !== a ? a.H() : null;
            return null !== a && null !== o ? (this._i = i, this.gi = a.K(i, o)) : (this._i = NaN, this.gi = NaN), s !== this.mi || h !== this.gi || e !== this.di || r !== this._i || u !== this.vi
        }, i.prototype.Pi = function () {
            var t = this.hi.P().map((function (t) {
                return t.Hi().Ui()
    ...
    var G = function () {
        ...
        return t.prototype.format = function (t) {
            ...
            var i = this.Gt / this.Yi, n = Math.floor(t), s = "", h = void 0 !== this.Xi ? this.Xi : NaN;
            if (i > 1) {
                var r = +(Math.round(t * i) - n * i).toFixed(this.Xi);
                r >= i && (r -= i, n += 1), s = Z + J(+r.toFixed(this.Xi) * this.Yi, h)
        ...
        return t.prototype.on = function (t) {
            ...
            if (v(t) && 0 !== this.an - this.un) {
                var i = .5 * (this.an + this.un), n = this.an - i, s = this.un - i;
    ...
    var _t, dt = function () {
        ...
        return t.prototype.yn = function (t, i, n) {
            for (var s, h, r, e = 0 === this.mn ? 0 : 1 / this.mn, u = Math.pow(10, Math.max(0, Math.ceil(ht(t - i)))), a = 0, o = this.gn[0]; ;) {
                var l = st(u, e, 1e-14) && u > e + 1e-14, f = st(u, n * o, 1e-14), c = st(u, 1, 1e-14);
                if (!(l && f && c)) break;
                u /= o, o = this.gn[++a % this.gn.length]
            }
            if (u <= e + 1e-14 && (u = e), u = Math.max(1, u), this.pn.length > 0 && (s = u, h = 1, r = 1e-14, Math.abs(s - h) < r)) for (a = 0, o = this.pn[0]; st(u, n * o, 1e-14) && u > e + 1e-14;) u /= o, o = this.pn[++a % this.pn.length];
            return u
        }, t
    }(), wt = function () {
        function t(t, i, n, s) {
            this.kn = [], this.Gt = t, this.mn = i, this.Cn = n, this.xn = s
        }

        return t.prototype.yn = function (t, i) {
            if (t < i) throw new Error("high < low");
            var n = this.Gt.Mt(), s = (t - i) * this.Nn() / n, h = new dt(this.mn, [2, 2.5, 2]),
                r = new dt(this.mn, [2, 2, 2.5]), e = new dt(this.mn, [2.5, 2, 2]), u = [];
            return u.push(h.yn(t, i, s), r.yn(t, i, s), e.yn(t, i, s)), function (t) {
            ...
            var t = this.Gt, i = t.H();
            if (null !== i) {
                var n = t.Mt(), s = this.Cn(n - 1, i), h = this.Cn(0, i),
                    r = this.Gt.ct().entireTextOnly ? this.Dn() / 2 : 0, e = r, u = n - 1 - r, a = Math.max(s, h),
                    o = Math.min(s, h);
                if (a !== o) {
                    for (var l = this.yn(a, o), f = a % l, c = a >= o ? 1 : -1, v = null, _ = 0, d = a - (f += f < 0 ? l : 0); d > o; d -= l) {
                        var w = this.xn(d, i, !0);
                        null !== v && Math.abs(w - v) < this.Nn() || (w < e || w > u || (_ < this.kn.length ? (this.kn[_].Tn = w, this.kn[_].An = t.Bn(d)) : this.kn.push({
                            Tn: w,
                            An: t.Bn(d)
    ...
    var bt, mt, gt = new Q, pt = new G(100, 1), yt = function () {
        function t(t, i, n, s) {
            this.Fn = 0, this.Vn = null, this.On = null, this.Pn = null, this.Wn = {
                zn: !1,
                Rn: null
            }, this.In = 0, this.jn = 0, this.qn = new tt, this.Un = new tt, this.Hn = [], this.Yn = null, this.Kn = null, this.$n = null, this.Xn = null, this.Zn = pt, this.Jn = t, this.ki = i, this.Gn = n, this.Qn = s, this.ts = new wt(this, 100, this.ns.bind(this), this.ss.bind(this))
        }
        ...
        return t.prototype.hs = function () {
            ...
            if (c(this.ki, t), this.es(), void 0 !== t.mode && this.us({os: t.mode}), void 0 !== t.scaleMargins) {
            ...
            return {_s: this.ki.autoScale, ds: this.ki.invertScale, os: this.ki.mode}
        }, t.prototype.us = function (t) {
            var i = this.os(), n = null;
            void 0 !== t._s && (this.ki.autoScale = t._s), void 0 !== t.os && (this.ki.mode = t.os, 2 !== t.os && 3 !== t.os || (this.ki.autoScale = !0), this.Wn.zn = !1), 1 === i.os && t.os !== i.os && (!function (t) {
                if (null === t) return !1;
                var i = ct(t.fn()), n = ct(t.cn());
                return isFinite(i) && isFinite(n)
            }(this.On) ? this.ki.autoScale = !0 : (n = function (t) {
                if (null === t) return null;
                var i = ct(t.fn()), n = ct(t.cn());
                return new it(i, n)
            }(this.On), null !== n && this.ws(n))), 1 === t.os && t.os !== i.os && null !== (n = vt(this.On)) && this.ws(n);
            var s = i.os !== this.ki.mode;
            s && (2 === i.os || this.cs()) && this.es(), s && (3 === i.os || this.vs()) && this.es(), void 0 !== t.ds && i.ds !== t.ds && (this.ki.invertScale = t.ds, this.Ms()), this.Un.hn(i, this.os())
            ...
            var n = this.On;
            (i || null === n && null !== t || null !== n && !n.on(t)) && (this.Kn = null, this.On = t)
        }, t.prototype.ti = function () {
            ...
            return this.cs() ? t = ut(t, i) : this.vs() && (t = ot(t, i)), this.ss(t, i)
        }, t.prototype.Ss = function (t, i, n) {
            this.xs();
            for (var s = this.ks(), h = l(this.Cs()), r = h.fn(), e = h.cn(), u = this.ps() - 1, a = this.ds(), o = u / (e - r), f = void 0 === n ? 0 : n.from, c = void 0 === n ? t.length : n.to, v = this.Ds(), _ = f; _ < c; _++) {
                var d = t[_], w = d.D;
                if (!isNaN(w)) {
                    var M = w;
                    null !== v && (M = v(d.D, i));
                    var b = s + o * (M - r), m = a ? b : this.Fn - 1 - b;
                    d.p = m
                }
            }
            ...
            for (var s = this.ks(), h = l(this.Cs()), r = h.fn(), e = h.cn(), u = this.ps() - 1, a = this.ds(), o = u / (e - r), f = void 0 === n ? 0 : n.from, c = void 0 === n ? t.length : n.to, v = this.Ds(), _ = f; _ < c; _++) {
                ...
                var g = s + o * (w - r), p = a ? g : this.Fn - 1 - g;
                d.As = p, g = s + o * (M - r), p = a ? g : this.Fn - 1 - g, d.Bs = p, g = s + o * (b - r), p = a ? g : this.Fn - 1 - g, d.Ls = p, g = s + o * (m - r), p = a ? g : this.Fn - 1 - g, d.Es = p
            }
            ...
            var n = t;
            return this.cs() ? n = function (t, i) {
                return i < 0 && (t = -t), t / 100 * i + i
            }(n, i) : this.vs() && (n = function (t, i) {
            ...
            this.Hn.splice(i, 1), 0 === this.Hn.length && (this.us({_s: !0}), this.ws(null)), this.es(), this.Ws()
            ...
            return this.Kn || (this.ts.Sn(), this.Kn = this.ts.En(), this.qn.hn()), this.Kn
        }, t.prototype.Is = function () {
            return this.qn
        }, t.prototype.js = function (t) {
            this.cs() || this.vs() || null === this.$n && null === this.Pn && (this.ti() || (this.$n = this.Fn - t, this.Pn = l(this.Cs()).ln()))
        }, t.prototype.qs = function (t) {
            if (!this.cs() && !this.vs() && null !== this.$n) {
                this.us({_s: !1}), (t = this.Fn - t) < 0 && (t = 0);
                var i = (this.$n + .2 * (this.Fn - 1)) / (t + .2 * (this.Fn - 1)), n = l(this.Pn).ln();
                i = Math.max(i, .1), n.dn(i), this.ws(n)
            }
        }, t.prototype.Us = function () {
            this.cs() || this.vs() || (this.$n = null, this.Pn = null)
        }, t.prototype.Hs = function (t) {
            this.fs() || null === this.Xn && null === this.Pn && (this.ti() || (this.Xn = t, this.Pn = l(this.Cs()).ln()))
        }, t.prototype.Ys = function (t) {
            if (!this.fs() && null !== this.Xn) {
                var i = l(this.Cs()).vn() / (this.ps() - 1), n = t - this.Xn;
                this.ds() && (n *= -1);
                var s = n * i, h = l(this.Pn).ln();
                h.wn(s), this.ws(h, !0), this.Kn = null
            }
        }, t.prototype.Ks = function () {
            this.fs() || null !== this.Xn && (this.Xn = null, this.Pn = null)
            ...
            this.Kn = null;
            var t = this.Js(), i = 100;
            null !== t && (i = Math.round(1 / t.ih())), this.Zn = pt, this.cs() ? (this.Zn = gt, i = 100) : this.vs() ? (this.Zn = new G(100, 1), i = 100) : null !== t && (this.Zn = t.$s()), this.ts = new wt(this, i, this.ns.bind(this), this.ss.bind(this)), this.ts.Sn()
            ...
            t = this.Ln() && t ? ft(t) : t;
            var n = l(this.Cs()), s = this.ks() + (this.ps() - 1) * (t - n.fn()) / n.vn();
            return this.Ns(s)
        }, t.prototype.ns = function (t, i) {
            if (this.xs(), this.ti()) return 0;
            var n = this.Ns(t), s = l(this.Cs()), h = s.fn() + s.vn() * ((n - this.ks()) / (this.ps() - 1));
            ...
            var t = this.Wn.Rn;
            if (null !== t) {
                for (var i = null, n = 0, s = 0, h = 0, r = this.Qs(); h < r.length; h++) {
                    var e = r[h];
                    if (e.U()) {
                        var u = e.H();
                        if (null !== u) {
                            var a = e.sh(t.hh(), t.rh()), o = a && a.Cs();
                            if (null !== o) {
                                switch (this.ki.mode) {
                                    case 1:
                                        o = vt(o);
                                ...
                                if (i = null === i ? o : i._n(l(o)), null !== a) {
                                    var f = a.eh();
                                    null !== f && (n = Math.max(n, f.above), s = Math.max(n, f.below))
                                }
                            }
                        }
                    }
                }
                if (n === this.In && s === this.jn || (this.In = n, this.jn = s, this.Kn = null, this.ls()), null !== i) {
                    if (i.fn() === i.cn()) {
                        var c = this.Js(), v = 5 * (null === c || this.cs() || this.vs() ? 1 : c.ih());
                        i = new it(i.fn() - v, i.cn() + v)
                    }
                    this.ws(i)
                } else null === this.On && this.ws(new it(-.5, .5));
                this.Wn.zn = !0
            }
        }, t.prototype.Ds = function () {
            return this.cs() ? ut : this.vs() ? ot : this.Ln() ? ft : null
        }, t.prototype.Xs = function (t, i) {
            return void 0 === this.Qn.priceFormatter ? (void 0 === i && (i = this.$s()), i.format(t)) : this.Qn.priceFormatter(t)
        }, t
    }();
    ...
    var Nt = function () {
        function t(t, i) {
            void 0 === t && (t = "yyyy-MM-dd"), void 0 === i && (i = "default"), this.uh = t, this.ah = i
        }
        ...
        return t.prototype.oh = function (t) {
            return this.lh.replace("%h", J(t.getUTCHours(), 2)).replace("%m", J(t.getUTCMinutes(), 2)).replace("%s", J(t.getUTCSeconds(), 2))
        }, t
    }(), Dt = {fh: "yyyy-MM-dd", _h: "%h:%m:%s", dh: " ", wh: "default"}, Tt = function () {
        function t(t) {
            void 0 === t && (t = {});
            var i = e(e({}, Dt), t);
            this.Mh = new Nt(i.fh, i.wh), this.bh = new St(i._h), this.mh = i.dh
        }
    ...
    var Lt = function () {
        function t(t, i) {
            void 0 === i && (i = 50), this.gh = 0, this.ph = 1, this.yh = 1, this.kh = new Map, this.Ch = new Map, this.xh = t, this.Nh = i
        }

        return t.prototype.oh = function (t) {
            var i = void 0 === t.Sh ? new Date(1e3 * t.Dh).getTime() : new Date(Date.UTC(t.Sh.year, t.Sh.month - 1, t.Sh.day)).getTime(),
                n = this.kh.get(i);
            ...
            var h = this.xh(t);
            return this.kh.set(i, {Th: h, Ah: this.ph}), this.Ch.set(this.ph, i), this.gh++, this.ph++, h
        }, t
    }(), Et = function () {
        function t(t, i) {
    ...
    var Vt, Ot = function () {
        ...
        return t.prototype.Oh = function (t, i) {
            this.Ph(i), this.kh = null;
            for (var n = i; n < t.length; ++n) {
                var s = t[n], h = this.Vh.get(s.Wh);
                void 0 === h && (h = [], this.Vh.set(s.Wh, h)), h.push({zh: n, S: s.S, Rh: s.Wh})
            }
        }, t.prototype.Ih = function (t, i) {
            var n = Math.ceil(i / t);
            return null !== this.kh && this.kh.jh === n || (this.kh = {En: this.qh(n), jh: n}), this.kh.En
        }, t.prototype.Ph = function (t) {
            if (0 !== t) {
                var i = [];
                this.Vh.forEach((function (n, s) {
                    t <= n[0].zh ? i.push(s) : n.splice(At(n, t, (function (i) {
                        return i.zh < t
                    })), 1 / 0)
                }));
            ...
            for (var i = [], n = 0, s = Array.from(this.Vh.keys()).sort((function (t, i) {
                return i - t
            })); n < s.length; n++) {
                var h = s[n];
                if (this.Vh.get(h)) {
                    var r = i;
                    i = [];
                    for (var e = r.length, u = 0, a = o(this.Vh.get(h)), l = a.length, f = 1 / 0, c = -1 / 0, v = 0; v < l; v++) {
    ...
    var Wt, zt = function () {
        function t(t, i, n) {
            this.$h = 0, this.Xh = null, this.Zh = [], this.Xn = null, this.$n = null, this.Jh = new Ot, this.Gh = new Map, this.Qh = Pt.Kh(), this.tr = !0, this.ir = new tt, this.nr = new tt, this.sr = new tt, this.hr = null, this.rr = null, this.er = [], this.ki = i, this.Qn = n, this.ur = i.rightOffset, this.ar = i.barSpacing, this.hi = t, this.lr()
        }
        ...
        return t.prototype.ct = function () {
            ...
            var n;
            c(this.ki, t), this.ki.fixLeftEdge && this._r(), this.ki.fixRightEdge && this.dr(), void 0 !== t.barSpacing && this.hi.wr(t.barSpacing), void 0 !== t.rightOffset && this.hi.Mr(t.rightOffset), void 0 !== t.minBarSpacing && this.hi.wr(null !== (n = t.barSpacing) && void 0 !== n ? n : this.ar), this.vr(), this.lr(), this.sr.hn()
        }, t.prototype.ri = function (t) {
            var i;
            return (null === (i = this.Zh[t]) || void 0 === i ? void 0 : i.S) || null
        }, t.prototype.br = function (t, i) {
            if (this.Zh.length < 1) return null;
            if (t.Dh > this.Zh[this.Zh.length - 1].S.Dh) return i ? this.Zh.length - 1 : null;
            ...
            var i = Math.round(t.from), n = Math.round(t.to), s = l(this.Cr()), h = l(this.Nr());
            return {from: l(this.ri(Math.max(s, i))), to: l(this.ri(Math.min(h, n)))}
            ...
            return this.$h - (i + .5) * this.ar - 1
        }, t.prototype.Lr = function (t, i) {
            for (var n = this.Br(), s = void 0 === i ? 0 : i.from, h = void 0 === i ? t.length : i.to, r = s; r < h; r++) {
                var e = t[r].S, u = n + this.ur - e, a = this.$h - (u + .5) * this.ar - 1;
                t[r].g = a
            }
            ...
            for (var t = this.ar, i = 5 * (this.hi.ct().layout.fontSize + 4), n = Math.round(i / t), s = l(this.mr()), h = Math.max(s.hh(), s.hh() - n), r = Math.max(s.rh(), s.rh() - n), e = this.Jh.Ih(t, i), u = this.Cr() + n, a = this.Nr() - n, o = 0, f = 0, c = e; f < c.length; f++) {
                var v = c[f];
                if (h <= v.zh && v.zh <= r) {
                    var _ = void 0;
                    o < this.er.length ? ((_ = this.er[o]).Tn = this.G(v.zh), _.An = this.Rr(v.S, v.Rh), _.Rh = v.Rh) : (_ = {
                        Ir: !1,
                        Tn: this.G(v.zh),
                        An: this.Rr(v.S, v.Rh),
                        Rh: v.Rh
                    }, this.er.push(_)), this.ar > i / 2 ? _.Ir = !1 : _.Ir = this.ki.fixLeftEdge && v.zh <= u || this.ki.fixRightEdge && v.zh >= a, o++
                }
            }
            ...
            var n = this.Fr(t), s = this.Pr(), h = s + i * (s / 10);
            this.wr(h), this.ki.rightBarStaysOnScroll || this.Mr(this.zr() + (n - this.Fr(t)))
        }, t.prototype.js = function (t) {
            this.Xn && this.Ks(), null === this.$n && null === this.hr && (this.ti() || (this.$n = t, this.Hr()))
        }, t.prototype.qs = function (t) {
            if (null !== this.hr) {
                var i = nt(this.$h - t, 0, this.$h), n = nt(this.$h - l(this.$n), 0, this.$h);
            ...
            var s = this.ur, h = performance.now(), r = function () {
            ...
            var i = t.Eh();
            this.Wr(this.$h / i), this.ur = t.rh() - this.Br(), this.Ar(), this.tr = !0, this.hi.Vr(), this.hi.Or()
        }, t.prototype.Qr = function () {
            var t = this.Cr(), i = this.Nr();
            null !== t && null !== i && this.Gr(new Et(t, i + this.ki.rightOffset))
        }, t.prototype.te = function (t) {
            var i = new Et(t.from, t.to);
            this.Gr(i)
        }, t.prototype.ei = function (t) {
            return void 0 !== this.Qn.timeFormatter ? this.Qn.timeFormatter(t.Sh || t.Dh) : this.ie.oh(new Date(1e3 * t.Dh))
            ...
            var i = this.ne(t), n = this.Br() + this.ur - i;
            return Math.round(1e6 * n) / 1e6
        }, t.prototype.Wr = function (t) {
            var i = this.ar;
            this.ar = t, this.Tr(), i !== this.ar && (this.tr = !0, this.se())
        }, t.prototype.gr = function () {
            if (this.tr) if (this.tr = !1, this.ti()) this.he(Pt.Kh()); else {
                var t = this.Br(), i = this.$h / this.ar, n = this.ur + t, s = new Et(n - i + 1, n);
                this.he(new Pt(s))
            }
            ...
            var t = this.Cr(), i = this.Xh;
            return null === t || null === i ? null : t - i - 1 + (this.ki.fixLeftEdge ? this.$h / this.ar : Math.min(2, this.Zh.length))
            ...
            var n = this, s = this.Gh.get(i);
            return void 0 === s && (s = new Lt((function (t) {
                return n.ae(t, i)
            })), this.Gh.set(i, s)), s.oh(t)
            ...
            return void 0 !== this.ki.tickMarkFormatter ? this.ki.tickMarkFormatter(null !== (n = t.Sh) && void 0 !== n ? n : t.Dh, s, this.Qn.locale) : function (t, i, n) {
                var s = {};
                switch (i) {
                    case 0:
                        s.year = "numeric";
                ...
                var h = void 0 === t.Sh ? new Date(1e3 * t.Dh) : new Date(Date.UTC(t.Sh.year, t.Sh.month - 1, t.Sh.day));
            ...
            var i = this.Qh;
            this.Qh = t, Ft(i.Hh(), this.Qh.Hh()) || this.ir.hn(), Ft(i.Yh(), this.Qh.Yh()) || this.nr.hn(), this.se()
    ...
    function qt(t, i, n) {
        return void 0 !== n ? n += " " : n = "", void 0 === i && (i = jt), "" + n + t + "px " + i
    }

    var Ut = function () {
        function t(t) {
            this.oe = {Tt: 1, Dt: 4, Pt: NaN, xt: "", le: "", et: "", Bt: 0, Lt: 0, Et: 0, At: 0, Ot: 0}, this.F = t
        }

        return t.prototype.ct = function () {
            var t = this.oe, i = this.fe(), n = this.ce();
            return t.Pt === i && t.le === n || (t.Pt = i, t.le = n, t.xt = qt(i, n), t.At = Math.floor(i / 3.5), t.Bt = t.At, t.Lt = Math.max(Math.ceil(i / 2 - t.Dt / 2), 0), t.Et = Math.ceil(i / 2 + t.Dt / 2), t.Ot = Math.round(i / 10)), t.et = this.ve(), this.oe
    ...
    var Yt = function () {
        ...
        return t.prototype.be = function (t, i) {
            var n = function (t, i) {
                return void 0 === t ? i : {me: Math.max(t.me, i.me), _s: t._s || i._s}
            }(this._e.get(t), i);
            this._e.set(t, n)
            ...
            var i = this._e.get(t);
            return void 0 === i ? {me: this.Me} : {me: Math.max(this.Me, i.me), _s: i._s}
            ...
            this.Me = Math.max(this.Me, t.Me), t._e.forEach((function (t, n) {
                i.be(n, t)
            }))
        ...
        return t.prototype.format = function (t) {
            var i = "";
            return t < 0 && (i = "-", t = -t), t < 995 ? i + this.Te(t) : t < 999995 ? i + this.Te(t / 1e3) + "K" : t < 999999995 ? (t = 1e3 * Math.round(t / 1e3), i + this.Te(t / 1e6) + "M") : (t = 1e6 * Math.round(t / 1e6), i + this.Te(t / 1e9) + "B")
        }, t.prototype.Te = function (t) {
    ...
    var Xt = function (t) {
        ...
        return r(i, t), i.prototype._ = function (t) {
            ...
            if (null !== this.v && 0 !== this.v.m.length && null !== this.v.M) {
                if (t.lineCap = "butt", t.lineJoin = "round", t.lineWidth = this.v.rt, n(t, this.v.ut), t.lineWidth = 1, t.beginPath(), 1 === this.v.m.length) {
                    var i = this.v.m[0], s = this.v.Ae / 2;
                    t.moveTo(i.g - s, this.v.Be), t.lineTo(i.g - s, i.p), t.lineTo(i.g + s, i.p), t.lineTo(i.g + s, this.v.Be)
                } else t.moveTo(this.v.m[this.v.M.from].g, this.v.Be), t.lineTo(this.v.m[this.v.M.from].g, this.v.m[this.v.M.from].p), $t(t, this.v.m, this.v.Le, this.v.M), this.v.M.to > this.v.M.from && (t.lineTo(this.v.m[this.v.M.to - 1].g, this.v.Be), t.lineTo(this.v.m[this.v.M.from].g, this.v.Be));
        ...
        return r(i, t), i.prototype.Ee = function (t) {
            var i = this.v, n = t.createLinearGradient(0, 0, 0, i.Fe);
        ...
        return r(i, t), i.prototype._ = function (t) {
            ...
            if (null !== this.v && 0 !== this.v.m.length && null !== this.v.M) {
                if (t.lineCap = "butt", t.lineWidth = this.v.rt, n(t, this.v.ut), t.strokeStyle = this.Pe(t), t.lineJoin = "round", t.beginPath(), 1 === this.v.m.length) {
                    var i = this.v.m[0];
                    t.moveTo(i.g - this.v.Ae / 2, i.p), t.lineTo(i.g + this.v.Ae / 2, i.p)
        ...
        return r(i, t), i.prototype.Pe = function () {
            return this.v.N
        }, i
    }(Jt);
    ...
    function ii(t, i, n) {
        var s = i.hh(), h = i.rh(), r = At(t, s, Qt), e = Bt(t, h, ti);
        if (!n) return {from: r, to: e};
        var u = r, a = e;
        return r > 0 && r < t.length && t[r].S >= s && (u = r - 1), e > 0 && e < t.length && t[e - 1].S <= h && (a = e + 1), {
            from: u,
            to: a
        }
    }
    ...
    var ni = function () {
        function t(t, i, n) {
            this.We = !0, this.ze = !0, this.Re = !0, this.Ie = [], this.je = null, this.qe = t, this.Ue = i, this.He = n
        }

        return t.prototype.O = function (t) {
            this.We = !0, "data" === t && (this.ze = !0), "options" === t && (this.Re = !0)
        }, t.prototype.Ye = function () {
            this.ze && (this.Ke(), this.ze = !1), this.We && (this.$e(), this.We = !1), this.Re && (this.Xe(), this.Re = !1)
        }, t.prototype.Ze = function () {
            this.je = null
        }, t.prototype.$e = function () {
            var t = this.qe.$(), i = this.Ue.j();
            if (this.Ze(), !i.ti() && !t.ti()) {
                var n = i.mr();
                if (null !== n && 0 !== this.qe.Hi().Je()) {
                    var s = this.qe.H();
                    null !== s && (this.je = ii(this.Ie, n, this.He), this.Ge(t, i, s.X))
                }
            }
        }, t
    }(), si = function (t) {
        ...
        return r(i, t), i.prototype.Ge = function (t, i, n) {
            ...
            var t = this, i = this.qe.tu();
            this.Ie = this.qe.Hi().iu().map((function (n) {
                var s = n.X[3];
        ...
        function i(i, n) {
            ...
            return s.ot = new g, s.su = new Zt, s.hu = new Gt, s.ot.i([s.su, s.hu]), s
        }
    ...
    var ri = function () {
        ...
        return t.prototype._ = function (t) {
            ...
            if (null !== this.tt && 0 !== this.tt.Hi.length && null !== this.tt.M) {
                if (this.ru = this.uu(i), this.ru >= 2) Math.max(1, Math.floor(i)) % 2 != this.ru % 2 && this.ru--;
                this.eu = this.tt.au ? Math.min(this.ru, Math.floor(i)) : this.ru;
                for (var h = null, r = this.eu <= this.ru && this.tt.Pr >= Math.floor(1.5 * i), e = this.tt.M.from; e < this.tt.M.to; ++e) {
                    var u = this.tt.Hi[e];
                    h !== u.et && (t.fillStyle = u.et, h = u.et);
                    var a = Math.floor(.5 * this.eu), o = Math.round(u.g * i), l = o - a, f = this.eu, c = l + f - 1,
                        v = Math.min(u.Bs, u.Ls), _ = Math.max(u.Bs, u.Ls), d = Math.round(v * i) - a,
                        w = Math.round(_ * i) + a, M = Math.max(w - d, this.eu);
                    t.fillRect(l, d, f, M);
                    var b = Math.ceil(1.5 * this.ru);
                    if (r) {
                        if (this.tt.ou) {
                            var m = o - b, g = Math.max(d, Math.round(u.As * i) - a), p = g + f - 1;
                            p > d + M - 1 && (g = (p = d + M - 1) - f + 1), t.fillRect(m, g, l - m, p - g + 1)
                        }
                        var y = o + b, k = Math.max(d, Math.round(u.Es * i) - a), C = k + f - 1;
                        C > d + M - 1 && (k = (C = d + M - 1) - f + 1), t.fillRect(c + 1, k, y - c, C - k + 1)
                    }
                }
            }
        ...
        return r(i, t), i.prototype.W = function (t, i) {
            ...
            var n = this.qe.ct();
            this.Ye();
            var s = {Hi: this.Ie, Pr: this.Ue.j().Pr(), ou: n.openVisible, au: n.thinBars, M: this.je};
        ...
        return r(i, t), i.prototype.Ee = function (t) {
            var i = this.v, n = t.createLinearGradient(0, 0, 0, i.Fe), s = nt(i.Be / i.Fe, 0, 1);
            return n.addColorStop(0, i.vu), n.addColorStop(s, i._u), n.addColorStop(s, i.du), n.addColorStop(1, i.wu), n
        }, i
    }(Xt), oi = function (t) {
        function i() {
            return null !== t && t.apply(this, arguments) || this
        ...
        return r(i, t), i.prototype.Pe = function (t) {
            var i = this.v, n = t.createLinearGradient(0, 0, 0, i.Fe), s = nt(i.Be / i.Fe, 0, 1);
            return n.addColorStop(0, i.Ve), n.addColorStop(s, i.Ve), n.addColorStop(s, i.Oe), n.addColorStop(1, i.Oe), n
        }, i
    }(Jt), li = function (t) {
        function i(i, n) {
            var s = t.call(this, i, n) || this;
            return s.Mu = new ai, s.bu = new oi, s.T = new g, s.T.i([s.Mu, s.bu]), s
        }
        ...
        return r(i, t), i.prototype.W = function (t, i) {
            ...
            var s = this.qe.ct();
            this.Ye();
            var h = this.qe.$().K(s.baseValue.price, n.X), r = this.Ue.j().Pr();
            return this.Mu._({
                m: this.Ie,
                vu: s.topFillColor1,
                _u: s.topFillColor2,
        ...
        return t.prototype._ = function (t) {
            ...
            if (null !== this.tt && 0 !== this.tt.Hi.length && null !== this.tt.M) {
                if (this.ru = function (t, i) {
                    if (t >= 2.5 && t <= 4) return Math.floor(3 * i);
                    var n = 1 - .2 * Math.atan(Math.max(4, t) - 4) / (.5 * Math.PI), s = Math.floor(t * n * i),
                        h = Math.floor(t * i), r = Math.min(s, h);
                    return Math.max(Math.floor(i), r)
                }(this.tt.Pr, i), this.ru >= 2) Math.floor(i) % 2 != this.ru % 2 && this.ru--;
                var h = this.tt.Hi;
                this.tt.mu && this.gu(t, h, this.tt.M, i), this.tt.pu && this.yu(t, h, this.tt.M, this.tt.Pr, i);
                var r = this.ku(i);
                (!this.tt.pu || this.ru > 2 * r) && this.Cu(t, h, this.tt.M, i)
            }
        }, t.prototype.gu = function (t, i, n, s) {
            if (null !== this.tt) {
                var h = "", r = Math.min(Math.floor(s), Math.floor(this.tt.Pr * s));
                ...
                for (var e = Math.floor(.5 * r), u = null, a = n.from; a < n.to; a++) {
                    ...
                    var l = Math.round(Math.min(o.As, o.Es) * s), f = Math.round(Math.max(o.As, o.Es) * s),
                        c = Math.round(o.Bs * s), v = Math.round(o.Ls * s), _ = Math.round(s * o.g) - e, d = _ + r - 1;
            ...
            this.ru <= 2 * i && (i = Math.floor(.5 * (this.ru - 1)));
            var n = Math.max(Math.floor(t), i);
            return this.ru <= 2 * n ? Math.max(Math.floor(t), Math.floor(1 * t)) : n
        }, t.prototype.yu = function (t, i, n, s, h) {
            if (null !== this.tt) for (var r = "", e = this.ku(h), u = null, a = n.from; a < n.to; a++) {
                var o = i[a];
                o.Z !== r && (t.fillStyle = o.Z, r = o.Z);
                var l = Math.round(o.g * h) - Math.floor(.5 * this.ru), f = l + this.ru - 1,
                    c = Math.round(Math.min(o.As, o.Es) * h), v = Math.round(Math.max(o.As, o.Es) * h);
                if (null !== u && (l = Math.max(u + 1, l), l = Math.min(l, f)), this.tt.Pr * h > 2 * e) P(t, l, c, f - l + 1, v - c + 1, e); else {
                    var _ = f - l + 1;
            ...
            if (null !== this.tt) for (var h = "", r = this.ku(s), e = n.from; e < n.to; e++) {
                var u = i[e], a = Math.round(Math.min(u.As, u.Es) * s), o = Math.round(Math.max(u.As, u.Es) * s),
                    l = Math.round(u.g * s) - Math.floor(.5 * this.ru), f = l + this.ru - 1;
                if (u.et !== h) {
                    var c = u.et;
                    t.fillStyle = c, h = c
                }
                this.tt.pu && (l += r, a += r, f -= r, o -= r), a > o || t.fillRect(l, a, f - l + 1, o - a + 1)
            }
        }, t
    }(), ci = function (t) {
        function i() {
        ...
        return r(i, t), i.prototype.W = function (t, i) {
            ...
            var n = this.qe.ct();
            this.Ye();
            var s = {Hi: this.Ie, Pr: this.Ue.j().Pr(), mu: n.wickVisible, pu: n.borderVisible, M: this.je};
            return this.ot._(s), this.ot
        }, i.prototype.Xe = function () {
            var t = this;
            this.Ie.forEach((function (i) {
        ...
        return t.prototype._ = function (t) {
            ...
            if (null !== this.tt && 0 !== this.tt.m.length && null !== this.tt.M) {
                ...
                for (var h = Math.max(1, Math.floor(i)), r = Math.round(this.tt.Au * i) - Math.floor(h / 2), e = r + h, u = this.tt.M.from; u < this.tt.M.to; u++) {
                    var a = this.tt.m[u], o = this.Du[u - this.tt.M.from], l = Math.round(a.p * i);
                    t.fillStyle = a.et;
                    var f = void 0, c = void 0;
                    l <= r ? (f = l, c = e) : (f = r, c = l - Math.floor(h / 2) + h), t.fillRect(o.hh, f, o.rh - o.hh + 1, c - f)
                }
            }
            ...
            if (null !== this.tt && 0 !== this.tt.m.length && null !== this.tt.M) {
                ...
                for (var s = this.tt.M.from; s < this.tt.M.to; s++) {
                    var h, r = this.tt.m[s], e = Math.round(r.g * t), u = void 0, a = void 0;
                    if (n % 2) u = e - (h = (n - 1) / 2), a = e + h; else u = e - (h = n / 2), a = e + h - 1;
                    this.Du[s - this.tt.M.from] = {hh: u, rh: a, Bu: e, Lu: r.g * t, S: r.S}
                }
                for (s = this.tt.M.from + 1; s < this.tt.M.to; s++) {
                    var o = this.Du[s - this.tt.M.from], l = this.Du[s - this.tt.M.from - 1];
                    o.S === l.S + 1 && (o.hh - l.rh !== i + 1 && (l.Bu > l.Lu ? l.rh = o.hh - i - 1 : o.hh = l.rh + i + 1))
                }
                ...
                if (i > 0 && f < 4) for (s = this.tt.M.from; s < this.tt.M.to; s++) {
                    (c = (o = this.Du[s - this.tt.M.from]).rh - o.hh + 1) > f && (o.Bu > o.Lu ? o.rh -= 1 : o.hh += 1)
                }
            } else this.Du = []
        }, t
    }();
    ...
    var wi = function (t) {
        ...
        return r(i, t), i.prototype.W = function (t, i) {
            ...
            var t = this.Ue.j().Pr();
            this.Eu = _i(t);
            for (var i = 0, n = 0, s = this.qe.ct().color, h = 0, r = this.qe.Hi().iu(); h < r.length; h++) {
                var e = r[h], u = e.X[3], a = void 0 !== e.et ? e.et : s, o = di(e.zh, u, a);
                ++i < this.Eu.m.length ? this.Eu.m[i] = o : this.Eu.m.push(o), this.Ie[n++] = {S: e.zh, g: 0}
            }
            ...
            if (null !== this.je) {
                var s = i.Pr(), h = l(i.mr()), r = t.K(this.qe.ct().base, n);
                i.Lr(this.Eu.m), t.Ss(this.Eu.m, n), this.Eu.Au = r, this.Eu.M = ii(this.Eu.m, h, !1), this.Eu.Pr = s, this.ot._(this.Eu)
            }
        }, i
    }(ni), Mi = function (t) {
        function i(i, n) {
    ...
    }(si), bi = /[2-9]/g, mi = function () {
        function t(t) {
            void 0 === t && (t = 50), this.kh = new Map, this.Fu = 0, this.Vu = Array.from(new Array(t))
        }

        return t.prototype.Ou = function () {
            this.kh.clear(), this.Vu.fill(void 0)
        }, t.prototype.Vt = function (t, i, n) {
            var s = n || bi, h = String(i).replace(s, "0"), r = this.kh.get(h);
            if (void 0 === r) {
                if (0 === (r = t.measureText(h).width) && 0 !== i.length) return 0;
                var e = this.Vu[this.Fu];
                void 0 !== e && this.kh.delete(e), this.Vu[this.Fu] = h, this.Fu = (this.Fu + 1) % this.Vu.length, this.kh.set(h, r)
            }
            return r
        }, t
    }(), gi = function () {
        function t(t) {
            this.Pu = null, this.oe = null, this.Wu = "right", this.$h = 0, this.zu = t
        }

        return t.prototype.Ru = function (t, i, n, s) {
            this.Pu = t, this.oe = i, this.$h = n, this.Wu = s
        }, t.prototype.h = function (t, i) {
            null !== this.oe && null !== this.Pu && this.Pu.h(t, this.oe, this.zu, this.$h, this.Wu, i)
        }, t
    }(), pi = function () {
        function t(t, i, n) {
            this.Iu = t, this.zu = new mi(50), this.ju = i, this.F = n, this.fe = -1, this.ot = new gi(this.zu)
        }
        ...
        return t.prototype.W = function (t, i) {
            ...
            var r = this.F.Yu();
            return r.Pt !== this.fe && (this.fe = r.Pt, this.zu.Ou()), this.ot.Ru(this.Iu.Zt(), r, i, h), this.ot
        }, t
    }(), yi = function () {
        function t() {
            this.tt = null
        ...
        return t.prototype._ = function (t) {
            ...
            if (null !== this.tt && !1 !== this.tt.U) {
                ...
                if (!(e < 0 || e > Math.ceil(this.tt.Mt * i))) {
                    ...
                    t.lineCap = "butt", t.strokeStyle = this.tt.et, t.lineWidth = Math.floor(this.tt.rt * i), n(t, this.tt.ut), s(t, e, 0, u)
                }
            }
        }, t
    }(), ki = function () {
        function t(t) {
            this.Ku = {
                ...
                ut: 0,
                U: !1
            }, this.$u = new yi, this.L = !0, this.qe = t, this.Ue = t.vt(), this.$u._(this.Ku)
        }

        return t.prototype.O = function () {
            this.L = !0
        }, t.prototype.W = function (t, i) {
            return this.qe.U() ? (this.L && (this.Xu(t, i), this.L = !1), this.$u) : null
        }, t
    }(), Ci = function (t) {
        function i(i) {
        ...
        return r(i, t), i.prototype.Xu = function (t, i) {
            this.Ku.U = !1;
            var n = this.qe.$(), s = n.os().os;
            if (2 === s || 3 === s) {
                var h = this.qe.ct();
                if (h.baseLineVisible && this.qe.U()) {
                    var r = this.qe.H();
                    null !== r && (this.Ku.U = !0, this.Ku.p = n.K(r.X, r.X), this.Ku.wt = i, this.Ku.Mt = t, this.Ku.et = h.baseLineColor, this.Ku.rt = h.baseLineWidth, this.Ku.ut = h.baseLineStyle)
                }
            }
        }, i
    }(ki), xi = function () {
        ...
        return t.prototype._ = function (t) {
            ...
            if (null !== h) {
                t.save();
                var r = Math.max(1, Math.floor(i)), e = r % 2 / 2, u = Math.round(h.Lu.x * i) + e, a = h.Lu.y * i;
                t.fillStyle = h.Ju, t.beginPath();
                var o = Math.max(2, 1.5 * h.Gu) * i;
                t.arc(u, a, o, 0, 2 * Math.PI, !1), t.fill(), t.fillStyle = h.Qu, t.beginPath(), t.arc(u, a, h.C * i, 0, 2 * Math.PI, !1), t.fill(), t.lineWidth = r, t.strokeStyle = h.ta, t.beginPath(), t.arc(u, a, h.C * i + r / 2, 0, 2 * Math.PI, !1), t.stroke(), t.restore()
            }
        }, t
    }(), Ni = [{ia: 0, na: .25, sa: 4, ha: 10, ra: .25, ea: 0, ua: .4, aa: .8}, {
        ia: .25,
        na: .525,
        sa: 10,
        ha: 14,
        ...
        ua: .8,
        aa: 0
    }, {ia: .525, na: 1, sa: 14, ha: 14, ra: 0, ea: 0, ua: 0, aa: 0}];
    ...
    function Di(t, i) {
        ...
        var u, o, l, f = (s - n.ia) / (n.na - n.ia);
        return {Qu: Si(i, f, n.ra, n.ea), ta: Si(i, f, n.ua, n.aa), C: (u = f, o = n.sa, l = n.ha, o + (l - o) * u)}
    }
    ...
    var Ti = function () {
        ...
        return t.prototype.O = function (t) {
            if (this.L = !0, "data" === t && 2 === this.ca.ct().lastPriceAnimation) {
                var i = performance.now(), n = this.fa - i;
            ...
            return this.L ? (this.R(t, i), this.L = !1, this.oa = !1) : this.oa && (this.da(), this.oa = !1), this.ot
        }, t.prototype.R = function (t, i) {
            this.ot._(null);
            var n = this.ca.vt().j(), s = n.mr(), h = this.ca.H();
            if (null !== s && null !== h) {
                var r = this.ca.wa(!0);
                if (!r.Ma && s.Fh(r.zh)) {
                    var e = {x: n.G(r.zh), y: this.ca.$().K(r.D, h.X)}, u = r.et, a = this.ca.ct().lineWidth,
                        o = Di(this.ba(), u);
    ...
    function Vi(t, i, n, s, h) {
        var r = (Bi("arrowUp", h) - 1) / 2, e = (et(h / 2) - 1) / 2;
    ...
    var Pi = function (t) {
        function i() {
            var i = null !== t && t.apply(this, arguments) || this;
            return i.tt = null, i.zu = new mi, i.fe = -1, i.ce = "", i.ma = "", i
        }

        return r(i, t), i.prototype._ = function (t) {
            this.tt = t
        }, i.prototype.Ru = function (t, i) {
            this.fe === t && this.ce === i || (this.fe = t, this.ce = i, this.ma = qt(t, i), this.zu.Ou())
            ...
            if (null !== this.tt && null !== this.tt.M) {
                ...
                for (var s = this.tt.M.from; s < this.tt.M.to; s++) {
                    var h = this.tt.m[s];
                    void 0 !== h.Ft && (h.Ft.wt = this.zu.Vt(t, h.Ft.Ca), h.Ft.Mt = this.fe), Wi(h, t)
                }
            }
        }, i
    }(p);
    ...
    function Wi(t, i) {
        i.fillStyle = t.et, void 0 !== t.Ft && function (t, i, n, s) {
            t.fillText(i, n, s)
        }(i, t.Ft.Ca, t.g - t.Ft.wt / 2, t.Ft.p), function (t, i) {
            if (0 === t.Je) return;
            switch (t.xa) {
                case"arrowDown":
                ...
                case"square":
                    return void function (t, i, n, s) {
                        var h = Bi("square", s), r = (h - 1) / 2, e = i - r, u = n - r;
                        t.fillRect(e, u, h, h)
                    }(i, t.g, t.p, t.Je)
            }
            t.xa
    ...
    function zi(t, i, n) {
        return !(void 0 === t.Ft || !function (t, i, n, s, h, r) {
            var e = s / 2;
            return h >= t && h <= t + n && r >= i - e && r <= i + e
        }(t.g, t.Ft.p, t.Ft.wt, t.Ft.Mt, i, n)) || function (t, i, n) {
            if (0 === t.Je) return !1;
            switch (t.xa) {
                case"arrowDown":
                case"arrowUp":
                ...
                case"circle":
                    return function (t, i, n, s, h) {
                        var r = 2 + Bi("circle", n) / 2, e = t - s, u = i - h;
    ...
    function Ri(t, i, n, s, h, r, e, u, a) {
        var o = v(n) ? n : n.close, l = v(n) ? n : n.high, f = v(n) ? n : n.low,
            c = v(i.size) ? Math.max(i.size, 0) : 1, _ = Li(u.Pr()) * c, d = _ / 2;
        switch (t.Je = _, i.position) {
            case"inBar":
                return t.p = e.K(o, a), void (void 0 !== t.Ft && (t.Ft.p = t.p + d + r + .6 * h));
            case"aboveBar":
                return t.p = e.K(l, a) - d - s.Na, void 0 !== t.Ft && (t.Ft.p = t.p - d - .6 * h, s.Na += 1.2 * h), void (s.Na += _ + r);
            case"belowBar":
                return t.p = e.K(f, a) + d + s.Sa, void 0 !== t.Ft && (t.Ft.p = t.p + d + r + .6 * h, s.Sa += 1.2 * h), void (s.Sa += _ + r)
        }
        i.position
    }
    ...
    var Ii = function () {
        function t(t, i) {
            this.L = !0, this.Da = !0, this.Ta = !0, this.Aa = null, this.ot = new Pi, this.ca = t, this.hi = i, this.tt = {
                m: [],
                M: null
            }
        }
        ...
        return t.prototype.O = function (t) {
            ...
            return this.ot.Ru(s.fontSize, s.fontFamily), this.ot._(this.tt), this.ot
        }, t.prototype.Ba = function () {
            if (this.Ta) {
                if (this.ca.La().length > 0) {
                    var t = this.hi.j().Pr(), i = Ei(t), n = 1.5 * Li(t) + 2 * i;
            ...
            var t = this.ca.$(), i = this.hi.j(), n = this.ca.La();
            this.Da && (this.tt.m = n.map((function (t) {
                return {S: t.time, g: 0, p: 0, Je: 0, xa: t.shape, et: t.color, ya: t.ya, ka: t.id, Ft: void 0}
            })), this.Da = !1);
            var s = this.hi.ct().layout;
            this.tt.M = null;
            var h = i.mr();
        ...
        return r(i, t), i.prototype.Xu = function (t, i) {
            ...
            if (s.priceLineVisible && this.qe.U()) {
                ...
                h.Ma || (n.U = !0, n.p = h.Wt, n.et = this.qe.Fa(h.et), n.wt = i, n.Mt = t, n.rt = s.priceLineWidth, n.ut = s.priceLineStyle)
            }
        }, i
    }(ki), qi = function (t) {
        function i(i) {
        ...
        return r(i, t), i.prototype.Jt = function (t, i, n) {
            ...
            var s = this.lt;
            if (s.U()) {
                var h = s.ct(), r = h.lastValueVisible, e = "" !== s.Va(), u = 0 === h.seriesLastValueMode,
                    a = s.wa(!1);
                if (!a.Ma) {
                    r && (t.Ft = this.Oa(a, r, u), t.U = 0 !== t.Ft.length), (e || u) && (i.Ft = this.Pa(a, r, e, u), i.U = i.Ft.length > 0);
                    var o = s.Fa(a.et), l = O(o);
                    n.yt = l.yt, n.et = l.kt, n.Wt = a.Wt, i.Z = s.vt().J(a.Wt / s.$().Mt()), t.Z = o
                }
            }
        }, i.prototype.Pa = function (t, i, n, s) {
            var h = "", r = this.lt.Va();
            return n && 0 !== r.length && (h += r + " "), i && s && (h += this.lt.$().cs() ? t.Wa : t.za), h.trim()
        ...
        return t.prototype.Cs = function () {
            return this.On
        }, t.prototype.eh = function () {
            return this.Ra
        }, t.prototype.Mn = function () {
            return null === this.On ? null : {priceRange: this.On.Mn(), margins: this.Ra || void 0}
        }, t.bn = function (i) {
        ...
        return r(i, t), i.prototype.Xu = function (t, i) {
            ...
            if (n.U = !1, this.qe.U()) {
                ...
                if (null !== s) {
                    var h = this.Ia.ct();
                    n.U = !0, n.p = s, n.et = h.color, n.wt = i, n.Mt = t, n.rt = h.lineWidth, n.ut = h.lineStyle
                }
            }
        }, i
    }(ki), Yi = function (t) {
        ...
        return r(i, t), i.prototype.Jt = function (t, i, n) {
            t.U = !1, i.U = !1;
            var s = this.Ia.ct(), h = s.axisLabelVisible, r = "" !== s.title, e = this.ca;
            if (h && e.U()) {
                var u = this.Ia.ja();
                if (null !== u) {
                    r && (i.Ft = s.title, i.U = !0), i.Z = e.vt().J(u / e.$().Mt()), t.Ft = e.$().Zs(s.price), t.U = !0;
                    var a = O(s.color);
        ...
        function t(t, i) {
            this.ca = t, this.ki = i, this.qa = new Hi(t, this), this.Iu = new Yi(t, this), this.Ua = new pi(this.Iu, t, t.vt())
        }
    ...
    }($), Xi = {fu: "", Su: "", Nu: ""}, Zi = function () {
        function t(t) {
            this.ca = t
        }

        return t.prototype.cu = function (t, i) {
            var n = this.ca.Ya(), s = this.ca.ct();
            switch (n) {
                case"Line":
                    return this.Ka(s);
                case"Area":
            ...
            var s = e({}, Xi), h = t.upColor, r = t.downColor, u = h, a = r, o = l(this.Qa(i, n)),
                c = f(o.X[0]) <= f(o.X[3]);
            return s.fu = c ? h : r, s.Su = c ? u : a, s
        }, t.prototype.Ja = function (t, i, n) {
            var s = e({}, Xi), h = t.upColor, r = t.downColor, u = t.borderUpColor, a = t.borderDownColor,
                o = t.wickUpColor, c = t.wickDownColor, v = l(this.Qa(i, n)), _ = f(v.X[0]) <= f(v.X[3]);
        ...
        return t.prototype.ro = function () {
            ...
            var i = this.wo(t);
            return i > 0 && (i -= 1), i !== this.no.length && this.uo(i) < t ? i : null
            ...
            for (var s = null, h = t; h < i; h++) {
                var r = this.no[h].X[n];
                Number.isNaN(r) || (null === s ? s = {mo: r, po: r} : (r < s.mo && (s.mo = r), r > s.po && (s.po = r)))
            }
            return s
        }, t.prototype.co = function (t, i, n) {
            if (this.ti()) return null;
            var s = null, h = l(this.eo()), r = l(this.Ui()), e = Math.max(t, h), u = Math.min(i, r),
                a = Math.ceil(e / Ji) * Ji, o = Math.max(a, Math.floor(u / Ji) * Ji), f = this.wo(e),
                c = this.Mo(Math.min(u, a, i));
            s = Qi(s, this.bo(f, c, n));
            var v = this.so.get(n);
            void 0 === v && (v = new Map, this.so.set(n, v));
            for (var _ = Math.max(a + 1, e); _ < o; _ += Ji) {
                var d = Math.floor(_ / Ji), w = v.get(d);
                if (void 0 === w) {
                    var M = this.wo(d * Ji), b = this.Mo((d + 1) * Ji - 1);
    ...
    function Qi(t, i) {
        return null === t ? i : null === i ? t : {mo: Math.min(t.mo, i.mo), po: Math.max(t.po, i.po)}
    }

    var tn = function (t) {
        function i(i, n, s) {
            var h = t.call(this, i) || this;
            h.tt = new Gi, h.qa = new ji(h), h.yo = [], h.ko = new Ci(h), h.Co = null, h.xo = null, h.No = [], h.So = [], h.Do = null, h.ki = n, h.To = s;
            var r = new qi(h);
            return h.Mi = [r], h.Ua = new pi(r, h, i), "Area" !== s && "Line" !== s && "Baseline" !== s || (h.Co = new Ti(h)), h.Ao(), h.Bo(), h
        }

        return r(i, t), i.prototype.en = function () {
            ...
            var s, h, r = this.vt().j().mr(), e = this.H();
            ...
            var o = s.X[3], l = this.tu().cu(h, {X: s}), f = n.K(o, e.X);
            return {Ma: !1, D: o, Ft: n.ii(o, e.X), Wa: n.Zs(o), za: n.Gs(o, e.X), et: l.fu, Wt: f, zh: h}
            ...
            void 0 !== i && i !== this.ki.priceScaleId && this.vt().Lo(this, i), c(this.ki, t), null !== this.ui && void 0 !== t.scaleMargins && this.ui.rs({scaleMargins: t.scaleMargins}), void 0 !== t.priceFormat && this.Ao(), this.vt().Eo(this), this.vt().Fo(), this.Ti.O("options")
        }, i.prototype._ = function (t) {
            var i;
            this.tt._(t), this.Vo(), this.Ti.O("data"), this.Ci.O("data"), null === (i = this.Co) || void 0 === i || i.O("data");
            ...
            this.Ci.O("data"), this.vt().Oo(i), this.vt().Eo(this), this.vt().Fo(), this.vt().Or()
            ...
            var i = this.tt.io(t);
            return null === i ? null : "Bar" === this.To || "Candlestick" === this.To ? {
                open: i.X[0],
                high: i.X[1],
                low: i.X[2],
                close: i.X[3]
            ...
            var i = this, n = this.Co;
            return null !== n && n.U() ? (null === this.Do && n._a() && (this.Do = setTimeout((function () {
                i.Do = null, i.vt().jo()
            }), 0)), n.va(), [n]) : []
            ...
            for (var n = u([], this.Mi, !0), s = 0, h = this.yo; s < h.length; s++) {
                var r = h[s];
                n.push(r.Ha())
            }
            return n
            ...
            if (!(("Line" === this.To || "Area" === this.To || "Baseline" === this.To) && this.ki.crosshairMarkerVisible)) return null;
            var i = this.tt.io(t);
            return null === i ? null : {D: i.X[3], C: this.Ho(), Z: this.Yo(), Y: this.Ko(t)}
            ...
            var n = "Line" === this.To || "Area" === this.To || "Baseline" === this.To || "Histogram" === this.To ? [3] : [2, 1],
                s = this.tt.fo(t, i, n), h = null !== s ? new it(s.mo, s.po) : null;
            if ("Histogram" === this.Ya()) {
                var r = this.ki.base, e = new it(r, r);
                h = null !== h ? h._n(e) : e
            }
            ...
            var t = this, i = this.vt().j();
            if (i.ti() || 0 === this.tt.Je()) this.So = []; else {
                var n = l(this.tt.eo());
                this.So = this.No.map((function (s, h) {
                    var r = l(i.br(s.time, !0)), e = r < n ? 1 : -1;
                    return {
        ...
        return t.prototype.$o = function (t, i, n) {
            var s = t;
            if (0 === this.ki.mode) return s;
            var h = n.Ni(), r = h.H();
            if (null === r) return s;
            var e = h.K(t, r), u = n.Vs().filter((function (t) {
        ...
        return t.prototype._ = function (t) {
            ...
            if (null !== this.tt) {
                ...
                t.lineWidth = e;
                var u = Math.ceil(this.tt.ht * i), a = Math.ceil(this.tt.st * i);
                !function (t, i) {
        ...
        function t(t, i) {
            this.Hn = [], this.hl = new Map, this.Fn = 0, this.$h = 0, this.rl = 1e3, this.Yn = null, this.el = new tt, this.ul = t, this.hi = i, this.al = new rn(this);
            var n = i.ct();
            this.ol = this.ll("left", n.leftPriceScale), this.fl = this.ll("right", n.rightPriceScale), this.ol.bs().Ji(this.cl.bind(this, this.ol), this), this.fl.bs().Ji(this.cl.bind(this, this.ol), this), this.vl(n)
        }

        return t.prototype.vl = function (t) {
            if (t.leftPriceScale && this.ol.rs(t.leftPriceScale), t.rightPriceScale && this.fl.rs(t.rightPriceScale), t.localization && (this.ol.es(), this.fl.es()), t.overlayPriceScales) for (var i = 0, n = Array.from(this.hl.values()); i < n.length; i++) {
                var s = l(n[i][0].$());
            ...
            var i = this;
            this.Fn = t, this.ol.gs(t), this.fl.gs(t), this.Hn.forEach((function (n) {
                if (i.Uu(n)) {
                    var s = n.$();
                    null !== s && s.gs(t)
                }
            ...
            var n = l(t.$()).hs();
            if (this.hl.has(n)) {
                var s = o(this.hl.get(n)), h = s.indexOf(t);
                -1 !== h && (s.splice(h, 1), 0 === s.length && this.hl.delete(n))
            }
            var r = t.$();
            r && r.Vs().indexOf(t) >= 0 && r.zs(t), null !== r && (r.Ws(), this.yl(r)), this.Yn = null
            ...
            var t = this;
            this.yl(this.ol), this.yl(this.fl), this.Hn.forEach((function (i) {
                t.Uu(i) && t.yl(i.$())
            })), this.bl(), this.hi.Or()
        }, t.prototype.Os = function () {
            ...
            var s = this._l(i);
            if (null === s && (s = this.ll(i, this.hi.ct().overlayPriceScales)), this.Hn.push(t), !Ht(i)) {
                var h = this.hl.get(i) || [];
            ...
            if (this.tt.U) {
                ...
                for (var i = 0, n = 0, s = this.tt.zl; n < s.length; n++) {
                    if (0 !== (a = s[n]).Ft.length) {
                        ...
                        h > this.tt.wt ? a.Ur = this.tt.wt / h : a.Ur = 1, i += a.Il * a.Ur
                    }
                }
                var r = 0;
                switch (this.tt.jl) {
                ...
                for (var e = 0, u = this.tt.zl; e < u.length; e++) {
                    ...
                    t.translate(o, r), t.textBaseline = "top", t.font = a.xt, t.scale(a.Ur, a.Ur), t.fillText(a.Ft, 0, a.Ul), t.restore(), r += a.Il * a.Ur
                }
                t.restore()
            }
        }, i.prototype.Rl = function (t, i) {
            var n = this.Hl(t.font), s = n.get(i);
        ...
        return t.prototype.O = function () {
            ...
            var n = this.lt.ct(), s = this.at;
            s.U = n.visible, s.U && (s.et = n.color, s.wt = i, s.Mt = t, s.ql = n.horzAlign, s.jl = n.vertAlign, s.zl = [{
                Ft: n.text,
        ...
        return r(i, t), i.prototype.zi = function () {
            return []
        }, i.prototype.Wi = function () {
            return [this.Ti]
        }, i.prototype.ct = function () {
        ...
        function t(t, i) {
            this.Yl = [], this.Kl = [], this.$h = 0, this.$l = null, this.Xl = null, this.Zl = new tt, this.Jl = new tt, this.Gl = null, this.Ql = t, this.ki = i, this.tf = new Ut(this), this.ul = new zt(this, i.timeScale, this.ki.localization), this.V = new X(this, i.crosshair), this.if = new nn(i.crosshair), this.nf = new on(this, i.watermark), this.sf(), this.Yl[0].Ml(2e3), this.hf = this.rf(0), this.ef = this.rf(1)
        }
        ...
        return t.prototype.uf = function () {
            ...
            var i = this.Xl;
            this.Xl = t, null !== i && this.Eo(i.vf), null !== t && this.Eo(t.vf)
        }, t.prototype.ct = function () {
            return this.ki
        }, t.prototype.rs = function (t) {
            c(this.ki, t), this.Yl.forEach((function (i) {
                return i.vl(t)
            ...
            this.$h = t, this.ul.Dr(this.$h), this.Yl.forEach((function (i) {
                return i.Dr(t)
            })), this.Vr()
        }, t.prototype.sf = function (t) {
            var i = new en(this.ul, this);
            void 0 !== t ? this.Yl.splice(t, 0, i) : this.Yl.push(i);
            var n = void 0 === t ? this.Yl.length - 1 : t, s = new Yt(3);
            ...
            var i = !1;
            return null !== this.$l && Math.abs(t - this.$l) > 20 && (this.$l = null, i = !0), this.ul.Ys(t), this.Vr(), i
            ...
            this.V.Ai(t, i);
            var s = NaN, h = this.ul.Er(t), r = this.ul.mr();
            null !== r && (h = Math.min(Math.max(r.hh(), h), r.rh()));
            var e = n.Ni(), u = e.H();
            null !== u && (s = e.Si(i, u)), s = this.if.$o(s, h, n), this.V.Fi(h, s, n), this.jo(), this.Jl.hn(this.V.I(), {
                x: t,
                y: i
            })
        }, t.prototype.Bf = function () {
            ...
            var h = this.ul.ri(0), r = this.ul.Br(), e = this.ul.mr();
            if (null !== e && null !== s && null !== h) {
                var u = e.Fh(r), a = s.Dh > h.Dh, o = null !== t && t > r && !a,
            ...
            var n = this.Yl[0], s = this.Vf(i, t, n);
            return this.Kl.push(s), 1 === this.Kl.length ? this.uf() : this.Or(), s
        }, t.prototype.Of = function (t) {
            var i = this.qu(t), n = this.Kl.indexOf(t);
            a(-1 !== n, "Series not found"), this.Kl.splice(n, 1), l(i).zs(t), t.en && t.en()
            ...
            var i = this.ef, n = this.hf;
            if (i === n) return i;
            if (t = Math.max(0, Math.min(100, Math.round(100 * t))), null === this.Gl || this.Gl.Ve !== n || this.Gl.Oe !== i) this.Gl = {
                Ve: n,
                Oe: i,
                If: new Map
            }; else {
            ...
            var h = function (t, i, n) {
                var s = V(t), h = s[0], r = s[1], e = s[2], u = s[3], a = V(i), o = a[0], l = a[1], f = a[2], c = a[3],
                    v = [T(h + n * (o - h)), T(r + n * (l - r)), T(e + n * (f - e)), A(u + n * (c - u))];
            ...
            this.Ql && this.Ql(t), this.Yl.forEach((function (t) {
                return t.Ol().sl().O()
            }))
        }, t.prototype.Vf = function (t, i, n) {
            var s = new tn(this, t, i), h = void 0 !== t.priceScaleId ? t.priceScaleId : this.Wf();
    ...
    function wn(t, i) {
        var n = t.createElement("canvas"), s = _n(n);
        return n.style.width = i.st + "px", n.style.height = i.ht + "px", n.width = i.st * s, n.height = i.ht * s, n
    }
    ...
    var gn = function () {
        function t(t, i, n, s) {
            this.qf = null, this.Uf = null, this.Hf = null, this.Yf = null, this.Kf = null, this.$f = 0, this.Xf = 0, this.Zf = !1, this.Jf = t, this.Gf = i, this.Qf = n, this.Yi = s
        }

        return t.prototype.tc = function (t, i) {
            if (null !== this.qf) {
                if (this.qf.S === i) return void (this.qf.jf = t);
                if (Math.abs(this.qf.jf - t) < this.Yi) return
            }
            this.Yf = this.Hf, this.Hf = this.Uf, this.Uf = this.qf, this.qf = {S: i, jf: t}
        }, t.prototype.ia = function (t, i) {
            if (null !== this.qf && null !== this.Uf && !(i - this.qf.S > 50)) {
                var n = 0, s = mn(this.qf, this.Uf, this.Gf), h = bn(this.qf, this.Uf), r = [s], e = [h];
                if (n += h, null !== this.Hf) {
                ...
                if (!(Math.abs(_) < this.Jf)) this.Kf = {
                    jf: t,
                    S: i
                }, this.Xf = _, this.$f = (f = Math.abs(_), c = this.Qf, v = Math.log(c), Math.log(1 * v / -f) / v)
            }
        }, t.prototype.ic = function (t) {
            var i = l(this.Kf), n = t - i.S;
            return i.jf + this.Xf * (Math.pow(this.Qf, n) - 1) / Math.log(this.Qf)
    ...
    var yn = function () {
        if (!pn) return !1;
        var t = !!navigator.maxTouchPoints || !!navigator.msMaxTouchPoints || !!pn && ("ontouchstart" in window || Boolean(window.DocumentTouch && document instanceof window.DocumentTouch));
    ...
    var kn = function () {
        ...
        function t(t, i, n) {
            this.ec = 0, this.uc = null, this.ac = null, this.oc = !1, this.lc = null, this.fc = !1, this.cc = !1, this.vc = null, this._c = null, this.dc = null, this.wc = null, this.Mc = 0, this.bc = !1, this.mc = !1, this.gc = !1, this.yc = t, this.kc = i, this.ki = n, this.Cc()
        }

        return t.prototype.en = function () {
            null !== this.vc && (this.vc(), this.vc = null), null !== this._c && (this._c(), this._c = null), null !== this.dc && (this.dc(), this.dc = null), this.xc(), this.Nc()
        }, t.prototype.Sc = function (t) {
            var i = this;
            this._c && this._c();
            ...
            }, this.yc.addEventListener("mousemove", n), Sn(t) && this.Dc(t);
            var s = this.Tc(t);
            ...
            if ((!("button" in t) || 0 === t.button) && null === this.wc) {
                ...
                if (!this.mc || !i) {
                    this.bc = !0;
                    var n = this.Tc(t), s = f(this.lc), h = Math.abs(s.g - n.Fc), r = Math.abs(s.p - n.Vc),
                        e = h + r > 5;
                    if (e || !i) {
                        if (e && !this.fc && i) {
                            var u = .5 * h, a = r >= u && !this.ki.Oc, o = u > r && !this.ki.Pc;
                            a || o || (this.mc = !0)
                        }
                        e && (this.fc = !0, this.cc = !0, i && this.xc()), this.mc || (this.Ac(n, this.kc.Wc), i && Dn(t))
                    }
                }
            }
            ...
            if (!("button" in t) || 0 === t.button) {
                var i = this.Tc(t);
                this.xc(), this.lc = null, this.gc = !1, this.dc && (this.dc(), this.dc = null), Sn(t) && this.Rc(t), this.Ac(i, this.kc.Ic), ++this.ec, this.uc && this.ec > 1 ? (this.Ac(i, this.kc.jc), this.Nc()) : this.cc || this.Ac(i, this.kc.qc), Sn(t) && (Dn(t), this.Rc(t), 0 === t.touches.length && (this.oc = !1))
            }
            ...
            if (!("button" in t) || 0 === t.button) {
                var i = this.Tc(t);
                this.cc = !1, this.fc = !1, this.mc = !1, Sn(t) && this.Sc(t), this.lc = {
                    g: i.Fc,
                    p: i.Vc
                }, this.dc && (this.dc(), this.dc = null);
                var n = this.Ec.bind(this), s = this.zc.bind(this), h = this.yc.ownerDocument.documentElement;
                this.dc = function () {
                ...
                }, h.addEventListener("touchmove", n, {passive: !1}), h.addEventListener("touchend", s, {passive: !1}), this.xc(), Sn(t) && 1 === t.touches.length ? this.ac = setTimeout(this.Hc.bind(this, t), 240) : (h.addEventListener("mousemove", n), h.addEventListener("mouseup", s)), this.gc = !0, this.Ac(i, this.kc.Yc), this.uc || (this.ec = 0, this.uc = setTimeout(this.Nc.bind(this), 500))
            }
        }, t.prototype.Cc = function () {
            var t = this;
            this.yc.addEventListener("mouseenter", this.Sc.bind(this)), this.yc.addEventListener("touchcancel", this.xc.bind(this));
            var i = this.yc.ownerDocument, n = function (i) {
                t.kc.Kc && (i.composed && t.yc.contains(i.composedPath()[0]) || i.target && t.yc.contains(i.target) || t.kc.Kc())
            };
            this.vc = function () {
                i.removeEventListener("mousedown", n), i.removeEventListener("touchstart", n)
            }, i.addEventListener("mousedown", n), i.addEventListener("touchstart", n, {passive: !0}), this.yc.addEventListener("mouseleave", this.Rc.bind(this)), this.yc.addEventListener("touchstart", this.Uc.bind(this), {passive: !0}), yn || this.yc.addEventListener("mousedown", this.Uc.bind(this)), this.$c(), this.yc.addEventListener("touchmove", (function () {
            }), {passive: !1})
        }, t.prototype.$c = function () {
            var t = this;
            void 0 === this.kc.Xc && void 0 === this.kc.Zc && void 0 === this.kc.Jc || (this.yc.addEventListener("touchstart", (function (i) {
                return t.Gc(i.touches)
            }), {passive: !0}), this.yc.addEventListener("touchmove", (function (i) {
                if (2 === i.touches.length && null !== t.wc && void 0 !== t.kc.Zc) {
                    var n = Nn(i.touches[0], i.touches[1]) / t.Mc;
                    t.kc.Zc(t.wc, n), Dn(i)
                }
            }), {passive: !1}), this.yc.addEventListener("touchend", (function (i) {
                t.Gc(i.touches)
            })))
            ...
            }, this.Mc = Nn(t[0], t[1]), void 0 !== this.kc.Xc && this.kc.Xc(), this.xc()
    ...
    var Tn = function () {
        function t(t, i, n, s) {
            this.zu = new mi(200), this.fe = 0, this._v = "", this.ma = "", this.Vu = [], this.dv = new Map, this.fe = t, this._v = i, this.ma = qt(t, n, s)
        }
        ...
        return t.prototype.en = function () {
            ...
            var n, s = this;
            if (this.dv.has(i)) n = o(this.dv.get(i)); else {
                if (this.Vu.length >= 200) {
                    var h = o(this.Vu.shift());
                    this.dv.delete(h)
                }
                var r = _n(t.canvas), e = Math.ceil(this.fe / 4.5), u = Math.round(this.fe / 10),
                    a = Math.ceil(this.zu.Vt(t, i)), l = rt(Math.round(a + 2 * e)), f = rt(this.fe + 2 * e),
                ...
                n = {
                    ...
                    Mt: Math.ceil(f * r),
                    mv: c
                }, 0 !== a && (this.Vu.push(n.Ft), this.dv.set(n.Ft, n)), W(t = dn(n.mv), r, (function () {
                    t.font = s.ma, t.fillStyle = s._v, t.fillText(i, 0, f - e - u)
                }))
            }
            return n
        }, t
        ...
        function t(t, i, n, s) {
            var h = this;
            this.Gt = null, this.gv = null, this.pv = null, this.yv = !1, this.kv = new mi(50), this.Cv = new Tn(11, "#000"), this._v = null, this.ma = null, this.xv = 0, this.Nv = function () {
                h.Sv(h.tf.ct()), h.vi.Dv().vt().Or()
            }, this.Tv = function () {
                h.vi.Dv().vt().Or()
            }, this.vi = t, this.ki = i, this.tf = n, this.Av = "left" === s, this.Bv = document.createElement("div"), this.Bv.style.height = "100%", this.Bv.style.overflow = "hidden", this.Bv.style.width = "25px", this.Bv.style.left = "0", this.Bv.style.position = "relative", this.Lv = Mn(this.Bv, new vn(16, 16)), this.Lv.subscribeCanvasConfigured(this.Nv);
            var r = this.Lv.canvas;
            r.style.position = "absolute", r.style.zIndex = "1", r.style.left = "0", r.style.top = "0", this.Ev = Mn(this.Bv, new vn(16, 16)), this.Ev.subscribeCanvasConfigured(this.Tv);
        ...
        return t.prototype.en = function () {
            this.Iv.en(), this.Ev.unsubscribeCanvasConfigured(this.Tv), this.Ev.destroy(), this.Lv.unsubscribeCanvasConfigured(this.Nv), this.Lv.destroy(), null !== this.Gt && this.Gt.Is().sn(this), this.Gt = null, null !== this.pv && (clearTimeout(this.pv), this.pv = null), this.Cv.en()
            ...
            var t = this.tf.ct(), i = this._v !== t.et, n = this.ma !== t.xt;
            return (i || n) && (this.Sv(t), this._v = t.et), n && (this.kv.Ou(), this.ma = t.xt), t
        }, t.prototype.Yv = function () {
            if (null === this.Gt) return 0;
            var t = 34, i = this.Hv(), n = dn(this.Lv.canvas), s = this.Gt.En();
            n.font = this.Uv(), s.length > 0 && (t = Math.max(this.kv.Vt(n, s[0].An), this.kv.Vt(n, s[s.length - 1].An)));
            ...
            if (null !== u && null !== this.gv) {
                var a = this.Gt.Si(1, u), o = this.Gt.Si(this.gv.ht - 2, u);
                t = Math.max(t, this.kv.Vt(n, this.Gt.ii(Math.floor(Math.min(a, o)) + .11111111111111, u)), this.kv.Vt(n, this.Gt.ii(Math.ceil(Math.max(a, o)) - .11111111111111, u)))
            }
            ...
            null !== this.gv && this.gv.on(t) || (this.gv = t, this.Lv.resizeCanvas({
                width: t.st,
                height: t.ht
            }), this.Ev.resizeCanvas({
                width: t.st,
                height: t.ht
            ...
            if (null !== this.gv) {
                if (1 !== t) {
                    ...
                    this.Gv(), this.Qv(i, this.Lv.pixelRatio), this.yu(i, this.Lv.pixelRatio), this.t_(i, this.Lv.pixelRatio), this.i_(i, this.Lv.pixelRatio)
                }
                var n = dn(this.Ev.canvas), s = this.gv.st, h = this.gv.ht;
            ...
            if (null !== this.Gt && !this.Gt.ti() && this.vi.Dv().ct().handleScale.axisPressedMouseMove.price) {
                var i = this.vi.Dv().vt(), n = this.vi.Zv();
            ...
            if (null !== this.Gt && this.vi.Dv().ct().handleScale.axisPressedMouseMove.price) {
                var i = this.vi.Dv().vt(), n = this.vi.Zv(), s = this.Gt;
                i.Nl(n, s, t.av)
            }
        }, t.prototype.Ov = function () {
            if (null !== this.Gt && this.vi.Dv().ct().handleScale.axisPressedMouseMove.price) {
                var t = this.vi.Dv().vt(), i = this.vi.Zv(), n = this.Gt;
            ...
            var t = this, i = [], n = null === this.Gt ? void 0 : this.Gt;
            return function (s) {
                for (var h = 0; h < s.length; ++h) for (var r = s[h].zi(t.vi.Zv(), n), e = 0; e < r.length; e++) i.push(r[e])
            }(this.vi.Zv().Os()), i
        }, t.prototype.Qv = function (t, i) {
            var n = this;
            if (null !== this.gv) {
                var s = this.gv.st, h = this.gv.ht;
                W(t, i, (function () {
                    var i = n.vi.Zv().vt(), r = i.Rf(), e = i.zf();
                    r === e ? z(t, 0, 0, s, h, r) : R(t, 0, 0, s, h, r, e)
                }))
            }
        }, t.prototype.yu = function (t, i) {
            if (null !== this.gv && null !== this.Gt && this.Gt.ct().borderVisible) {
                t.save(), t.fillStyle = this.N();
                var n, s = Math.max(1, Math.floor(this.Hv().Tt * i));
                n = this.Av ? Math.floor(this.gv.st * i) - s : 0, t.fillRect(n, 0, s, Math.ceil(this.gv.ht * i)), t.restore()
            }
        }, t.prototype.t_ = function (t, i) {
            if (null !== this.gv && null !== this.Gt) {
                var n = this.Gt.En();
                t.save(), t.strokeStyle = this.N(), t.font = this.Uv(), t.fillStyle = this.N();
                var s = this.Hv(), h = this.Gt.ct().borderVisible && this.Gt.ct().drawTicks,
                    r = this.Av ? Math.floor((this.gv.st - s.Dt) * i - s.Tt * i) : Math.floor(s.Tt * i),
                    e = this.Av ? Math.round(r - s.Lt * i) : Math.round(r + s.Dt * i + s.Lt * i),
                    u = this.Av ? "right" : "left", a = Math.max(1, Math.floor(i)), o = Math.floor(.5 * i);
                if (h) {
            ...
            if (null !== this.gv && null !== this.Gt) {
                var t = this.gv.ht / 2, i = [], n = this.Gt.Os().slice(), s = this.vi.Zv(), h = this.Hv();
                this.Gt === s.Ni() && this.vi.Zv().Os().forEach((function (t) {
                    s.Uu(t) && n.push(t)
                }));
                var r = this.Gt.Vs()[0], e = this.Gt;
                n.forEach((function (n) {
                    var h = n.zi(s, e);
            ...
            if (null !== this.gv) {
                t.save();
                var s = this.gv, h = this.Kv(), r = this.Hv(), e = this.Av ? "right" : "left";
            ...
            if (null !== this.gv && null !== this.Gt) {
                t.save();
                var s = this.gv, h = this.vi.Dv().vt(), r = [], e = this.vi.Zv(), u = h.bf().zi(e, this.Gt);
                u.length && r.push(u);
                var a = this.Hv(), o = this.Av ? "right" : "left";
            ...
            var t = this, i = this.Yv();
            if (this.xv < i) {
                var n = this.vi.Dv();
                null === this.pv && (this.pv = setTimeout((function () {
                    n && n.vt().uf(), t.pv = null
                }), 100))
            }
            this.xv = i
    ...
    var On = function () {
        function t(t, i) {
            var n = this;
            this.gv = new vn(0, 0), this.r_ = null, this.e_ = null, this.u_ = null, this.a_ = !1, this.o_ = new tt, this.l_ = 0, this.f_ = !1, this.c_ = null, this.v_ = !1, this.__ = null, this.d_ = null, this.Nv = function () {
                return n.w_ && n.hi().Or()
            }, this.Tv = function () {
                return n.w_ && n.hi().Or()
            }, this.M_ = t, this.w_ = i, this.w_.Vl().Ji(this.b_.bind(this), this, !0), this.m_ = document.createElement("td"), this.m_.style.padding = "0", this.m_.style.position = "relative";
            var s = document.createElement("div");
            s.style.width = "100%", s.style.height = "100%", s.style.position = "relative", s.style.overflow = "hidden", this.g_ = document.createElement("td"), this.g_.style.padding = "0", this.p_ = document.createElement("td"), this.p_.style.padding = "0", this.m_.appendChild(s), this.Lv = Mn(s, new vn(16, 16)), this.Lv.subscribeCanvasConfigured(this.Nv);
            var h = this.Lv.canvas;
            h.style.position = "absolute", h.style.zIndex = "1", h.style.left = "0", h.style.top = "0", this.Ev = Mn(s, new vn(16, 16)), this.Ev.subscribeCanvasConfigured(this.Tv);
            var r = this.Ev.canvas;
            r.style.position = "absolute", r.style.zIndex = "2", r.style.left = "0", r.style.top = "0", this.y_ = document.createElement("tr"), this.y_.appendChild(this.g_), this.y_.appendChild(this.m_), this.y_.appendChild(this.p_), this.k_();
            var e = this.Dv().ct().handleScroll;
            this.Iv = new Cn(this.Ev.canvas, this, {Oc: !e.vertTouchDrag, Pc: !e.horzTouchDrag})
        }

        return t.prototype.en = function () {
            null !== this.r_ && this.r_.en(), null !== this.e_ && this.e_.en(), this.Ev.unsubscribeCanvasConfigured(this.Tv), this.Ev.destroy(), this.Lv.unsubscribeCanvasConfigured(this.Nv), this.Lv.destroy(), null !== this.w_ && this.w_.Vl().sn(this), this.Iv.en()
        }, t.prototype.Zv = function () {
            return l(this.w_)
        }, t.prototype.C_ = function (i) {
            null !== this.w_ && this.w_.Vl().sn(this), this.w_ = i, null !== this.w_ && this.w_.Vl().Ji(t.prototype.b_.bind(this), this, !0), this.k_()
            ...
            if (this.f_ = !1, this.v_ = null !== this.c_, this.w_) {
                if (this.S_(), document.activeElement !== document.body && document.activeElement !== document.documentElement) l(document.activeElement).blur(); else {
                ...
                if (!this.w_.Ni().ti() && !n.j().ti()) {
                    if (null !== this.c_) {
                        var s = n.bf();
                        this.__ = {x: s.bt(), y: s.gt()}, this.c_ = {x: t.uv, y: t.av}
                    }
            ...
            if (null !== this.w_) {
                var i = this.hi(), n = t.uv, s = t.av;
                if (null !== this.c_) {
                    this.v_ = !1;
                    var h = l(this.__), r = h.x + (n - this.c_.x), e = h.y + (s - this.c_.y);
                    this.N_(r, e)
                } else this.D_() || this.N_(n, s);
                if (!i.j().ti()) {
                    var u = this.M_.ct(), a = u.handleScroll, o = u.kineticScroll;
                    if (a.pressedMouseMove && "touch" !== t.ke || (a.horzTouchDrag || a.vertTouchDrag) && "mouse" !== t.ke) {
                        var f = this.w_.Ni(), c = performance.now();
                        null !== this.u_ || this.L_() || (this.u_ = {
                            ...
                            uv: t.uv,
                            av: t.av
                        }), null !== this.d_ && this.d_.tc(t.uv, c), null === this.u_ || this.a_ || this.u_.x === t.sv && this.u_.y === t.hv || (null === this.d_ && ("touch" === t.ke && o.touch || "mouse" === t.ke && o.mouse) && (this.d_ = new gn(.2, 7, .997, 15), this.d_.tc(this.u_.uv, this.u_.Dh), this.d_.tc(t.uv, c)), f.ti() || i.Dl(this.w_, f, t.av), i.xf(t.uv), this.a_ = !0), this.a_ && (f.ti() || i.Tl(this.w_, f, t.av), i.Nf(t.uv))
                    }
                }
            }
        }, t.prototype.Ic = function (t) {
            ...
            for (var s = 0, h = n.Os(); s < h.length; s++) {
                var r = h[s], e = this.O_(r.Wi(n), t, i);
            ...
            this.gv.on(t) || (this.gv = t, this.Lv.resizeCanvas({
                width: t.st,
                height: t.ht
            }), this.Ev.resizeCanvas({
                width: t.st,
            ...
            if (0 !== t && null !== this.w_) {
                if (t > 1 && this.z_(), null !== this.r_ && this.r_.Jv(t), null !== this.e_ && this.e_.Jv(t), 1 !== t) {
                    var i = dn(this.Lv.canvas);
                    i.save(), this.Qv(i, this.Lv.pixelRatio), this.w_ && (this.R_(i, this.Lv.pixelRatio), this.I_(i, this.Lv.pixelRatio), this.j_(i, this.Lv.pixelRatio, Fn)), i.restore()
                }
                var n = dn(this.Ev.canvas);
                n.clearRect(0, 0, Math.ceil(this.gv.st * this.Ev.pixelRatio), Math.ceil(this.gv.ht * this.Ev.pixelRatio)), this.j_(n, this.Lv.pixelRatio, Vn), this.q_(n, this.Ev.pixelRatio)
            }
            ...
            var n = this;
            W(t, i, (function () {
                var i = n.hi(), s = i.Rf(), h = i.zf();
                s === h ? z(t, 0, 0, n.gv.st, n.gv.ht, h) : R(t, 0, 0, n.gv.st, n.gv.ht, s, h)
            }))
        }, t.prototype.R_ = function (t, i) {
            var n = l(this.w_), s = n.Ol().sl().W(n.Mt(), n.wt());
            ...
            for (var r = l(this.w_), e = n(h, r), u = r.Mt(), a = r.wt(), o = r.vt().ff(), f = null !== o && o.vf === h, c = null !== o && f && void 0 !== o.A_ ? o.A_.pa : void 0, v = 0, _ = e; v < _.length; v++) {
                var d = _[v].W(u, a);
                null !== d && (t.save(), s(d, t, i, f, c), t.restore())
            }
        }, t.prototype.O_ = function (t, i, n) {
            for (var s = 0, h = t; s < h.length; s++) {
                var r = h[s], e = r.W(this.gv.ht, this.gv.st);
                if (null !== e && e.ga) {
                    var u = e.ga(i, n);
            ...
            if (null !== this.w_) {
                var t = this.M_, i = this.w_.kl().ct().visible, n = this.w_.Cl().ct().visible;
                i || null === this.r_ || (this.g_.removeChild(this.r_.jv()), this.r_.en(), this.r_ = null), n || null === this.e_ || (this.p_.removeChild(this.e_.jv()), this.e_.en(), this.e_ = null);
                var s = t.vt().Ef();
                i && null === this.r_ && (this.r_ = new An(this, t.ct().layout, s, "left"), this.g_.appendChild(this.r_.jv())), n && null === this.e_ && (this.e_ = new An(this, t.ct().layout, s, "right"), this.p_.appendChild(this.e_.jv()))
            }
            ...
            var t = this.hi(), i = this.Zv(), n = i.Ni();
            t.Al(i, n), t.Sf(), this.u_ = null, this.a_ = !1
        }, t.prototype.E_ = function (t) {
            var i = this;
            if (this.a_) {
                var n = performance.now();
                if (null !== this.d_ && this.d_.ia(t.uv, n), null === this.d_ || this.d_.nc(n)) this.Z_(); else {
                    var s = this.hi(), h = s.j(), r = this.d_, e = function () {
                        if (!r.hc()) {
                            var t = performance.now(), n = r.nc(t);
                            if (!r.hc()) {
                                var u = h.zr();
            ...
            var t = performance.now(), i = null === this.d_ || this.d_.nc(t);
            null !== this.d_ && (i || this.Z_()), null !== this.d_ && (this.d_.rc(), this.d_ = null)
        }, t
    }(), Pn = function () {
        function t(t, i, n, s, h) {
            var r = this;
            this.L = !0, this.gv = new vn(0, 0), this.Nv = function () {
                return r.Jv(3)
            }, this.Av = "left" === t, this.tf = n.Ef, this.ki = i, this.J_ = s, this.G_ = h, this.Bv = document.createElement("div"), this.Bv.style.width = "25px", this.Bv.style.height = "100%", this.Bv.style.overflow = "hidden", this.Lv = Mn(this.Bv, new vn(16, 16)), this.Lv.subscribeCanvasConfigured(this.Nv)
        }
        ...
        return t.prototype.en = function () {
            ...
            if (this.J_()) {
                ...
                var s = Math.floor(this.tf.ct().Tt * i), h = this.Av ? Math.round(n * i) - s : 0;
    ...
    var zn = function () {
        function t(t) {
            var i = this;
            this.Q_ = null, this.td = null, this.oe = null, this.nd = !1, this.gv = new vn(0, 0), this.sd = new tt, this.kv = new mi(5), this.Nv = function () {
                return i.M_.vt().Or()
            }, this.Tv = function () {
                return i.M_.vt().Or()
            }, this.M_ = t, this.ki = t.ct().layout, this.hd = document.createElement("tr"), this.rd = document.createElement("td"), this.rd.style.padding = "0", this.ed = document.createElement("td"), this.ed.style.padding = "0", this.Bv = document.createElement("td"), this.Bv.style.height = "25px", this.Bv.style.padding = "0", this.ud = document.createElement("div"), this.ud.style.width = "100%", this.ud.style.height = "100%", this.ud.style.position = "relative", this.ud.style.overflow = "hidden", this.Bv.appendChild(this.ud), this.Lv = Mn(this.ud, new vn(16, 16)), this.Lv.subscribeCanvasConfigured(this.Nv);
            var n = this.Lv.canvas;
            n.style.position = "absolute", n.style.zIndex = "1", n.style.left = "0", n.style.top = "0", this.Ev = Mn(this.ud, new vn(16, 16)), this.Ev.subscribeCanvasConfigured(this.Tv);
            var s = this.Ev.canvas;
            s.style.position = "absolute", s.style.zIndex = "2", s.style.left = "0", s.style.top = "0", this.hd.appendChild(this.rd), this.hd.appendChild(this.Bv), this.hd.appendChild(this.ed), this.ad(), this.M_.vt().dl().Ji(this.ad.bind(this), this), this.Iv = new Cn(this.Ev.canvas, this, {
                Oc: !0,
                Pc: !1
            })
        }
        ...
        return t.prototype.en = function () {
            this.Iv.en(), null !== this.Q_ && this.Q_.en(), null !== this.td && this.td.en(), this.Ev.unsubscribeCanvasConfigured(this.Tv), this.Ev.destroy(), this.Lv.unsubscribeCanvasConfigured(this.Nv), this.Lv.destroy()
        }, t.prototype.jv = function () {
            return this.hd
            ...
            if (!this.nd) {
                this.nd = !0;
                var i = this.M_.vt();
                !i.j().ti() && this.M_.ct().handleScale.axisPressedMouseMove.time && i.yf(t.uv)
            }
        }, t.prototype.Kc = function () {
            var t = this.M_.vt();
            !t.j().ti() && this.nd && (this.nd = !1, this.M_.ct().handleScale.axisPressedMouseMove.time && t.Tf())
        }, t.prototype.Wc = function (t) {
            var i = this.M_.vt();
            !i.j().ti() && this.M_.ct().handleScale.axisPressedMouseMove.time && i.Df(t.uv)
        }, t.prototype.Ic = function (t) {
            this.nd = !1;
            var i = this.M_.vt();
            i.j().ti() && !this.M_.ct().handleScale.axisPressedMouseMove.time || i.Tf()
            ...
            this.gv && this.gv.on(t) || (this.gv = t, this.Lv.resizeCanvas({
                width: t.st,
                height: t.ht
            }), this.Ev.resizeCanvas({
                width: t.st,
                height: t.ht
            }), this.Bv.style.width = t.st + "px", this.Bv.style.height = t.ht + "px", this.sd.hn(t)), null !== this.Q_ && this.Q_.$v(new vn(i, t.ht)), null !== this.td && this.td.$v(new vn(n, t.ht))
            ...
            if (0 !== t) {
                if (1 !== t) {
                    var i = dn(this.Lv.canvas);
                    this.Qv(i, this.Lv.pixelRatio), this.yu(i, this.Lv.pixelRatio), this.t_(i, this.Lv.pixelRatio), null !== this.Q_ && this.Q_.Jv(t), null !== this.td && this.td.Jv(t)
                }
                var n = dn(this.Ev.canvas), s = this.Ev.pixelRatio;
                n.clearRect(0, 0, Math.ceil(this.gv.st * s), Math.ceil(this.gv.ht * s)), this.wd([this.M_.vt().bf()], n, s)
            }
        }, t.prototype.Qv = function (t, i) {
            var n = this;
            W(t, i, (function () {
            ...
            var n = this, s = this.M_.vt().j().En();
            if (s && 0 !== s.length) {
                var h = s.reduce(Wn, s[0]).Rh;
                h > 30 && h < 50 && (h = 30), t.save(), t.strokeStyle = this.Md();
                var r = this.dd(), e = r.Tt + r.Dt + r.At + r.Pt - r.Ot;
                t.textAlign = "center", t.fillStyle = this.Md();
                var u = Math.floor(this.dd().Tt * i), a = Math.max(1, Math.floor(i)), o = Math.floor(.5 * i);
                ...
                t.fillStyle = this.ve(), W(t, i, (function () {
                    t.font = n.bd();
            ...
            var s = this.kv.Vt(t, n), h = s / 2, r = Math.floor(i - h) + .5;
            return r < 0 ? i += Math.abs(0 - r) : r + s > this.gv.st && (i -= Math.abs(this.gv.st - (r + s))), i
        }, t.prototype.wd = function (t, i, n) {
            for (var s = this.dd(), h = 0, r = t; h < r.length; h++) for (var e = 0, u = r[h].ci(); e < u.length; e++) {
                var a = u[e];
            ...
            var t = this.oe, i = this.bd();
            if (t.xt !== i) {
                var n = this.fe();
                t.Pt = n, t.xt = i, t.At = Math.ceil(n / 2.5), t.Bt = t.At, t.si = Math.ceil(n / 2), t.Ot = Math.round(this.fe() / 5), t.ni.Ou()
            }
            return this.oe
        }, t.prototype.h_ = function (t) {
            this.Bv.style.cursor = 1 === t ? "ew-resize" : "default"
        }, t.prototype.ad = function () {
            var t = this.M_.vt(), i = t.ct();
            i.leftPriceScale.visible || null === this.Q_ || (this.rd.removeChild(this.Q_.jv()), this.Q_.en(), this.Q_ = null), i.rightPriceScale.visible || null === this.td || (this.ed.removeChild(this.td.jv()), this.td.en(), this.td = null);
            var n = {Ef: this.M_.vt().Ef()}, s = function () {
                return i.leftPriceScale.borderVisible && t.j().ct().borderVisible
            }, h = function () {
                return t.zf()
            };
            i.leftPriceScale.visible && null === this.Q_ && (this.Q_ = new Pn("left", i, n, s, h), this.rd.appendChild(this.Q_.jv())), i.rightPriceScale.visible && null === this.td && (this.td = new Pn("right", i, n, s, h), this.ed.appendChild(this.td.jv()))
        }, t
    }(), Rn = function () {
        function t(t, i) {
            var n;
            this.pd = [], this.yd = 0, this.Fn = 0, this.$h = 0, this.kd = 0, this.Cd = 0, this.xd = null, this.Nd = !1, this.o_ = new tt, this.Jl = new tt, this.ki = i, this.hd = document.createElement("div"), this.hd.classList.add("tv-lightweight-charts"), this.hd.style.overflow = "hidden", this.hd.style.width = "100%", this.hd.style.height = "100%", (n = this.hd).style.userSelect = "none", n.style.webkitUserSelect = "none", n.style.msUserSelect = "none", n.style.MozUserSelect = "none", n.style.webkitTapHighlightColor = "transparent", this.Sd = document.createElement("table"), this.Sd.setAttribute("cellspacing", "0"), this.hd.appendChild(this.Sd), this.Dd = this.Td.bind(this), this.hd.addEventListener("wheel", this.Dd, {passive: !1}), this.hi = new ln(this.Ql.bind(this), this.ki), this.vt().mf().Ji(this.Ad.bind(this), this), this.Bd = new zn(this), this.Sd.appendChild(this.Bd.jv());
            var s = this.ki.width, h = this.ki.height;
            if (0 === s || 0 === h) {
                var r = t.getBoundingClientRect();
                0 === s && (s = Math.floor(r.width), s -= s % 2), 0 === h && (h = Math.floor(r.height), h -= h % 2)
            }
            this.Ld(s, h), this.Ed(), t.appendChild(this.hd), this.Fd(), this.hi.j().Jr().Ji(this.hi.uf.bind(this.hi), this), this.hi.dl().Ji(this.hi.uf.bind(this.hi), this)
        }
        ...
        return t.prototype.vt = function () {
            ...
            this.pd = [], l(this.Bd).en(), null !== this.hd.parentElement && this.hd.parentElement.removeChild(this.hd), this.Jl.en(), this.o_.en()
        }, t.prototype.Ld = function (t, i, n) {
            if (void 0 === n && (n = !1), this.Fn !== i || this.$h !== t) {
                this.Fn = i, this.$h = t;
                var s = i + "px", h = t + "px";
                l(this.hd).style.height = s, l(this.hd).style.width = h, this.Sd.style.height = s, this.Sd.style.width = h, n ? this.Pd(new Yt(3)) : this.hi.uf()
            }
        }, t.prototype.Jv = function (t) {
            void 0 === t && (t = new Yt(3));
            ...
            var i = t.width || this.$h, n = t.height || this.Fn;
            this.Ld(i, n)
        }, t.prototype.V_ = function () {
            return this.o_
        }, t.prototype.mf = function () {
            ...
            var i = this.pd[0], n = wn(document, new vn(this.$h, this.Fn)), s = dn(n), h = _n(n);
            return W(s, h, (function () {
                var n = 0, h = 0, r = function (i) {
                    for (var r = 0; r < t.pd.length; r++) {
                        var e = t.pd[r], u = e.W_().ht, a = l("left" === i ? e.U_() : e.H_()), o = a.s_();
                        s.drawImage(o, n, h, a.Xv(), u), h += u
                    }
                };
                t.zd() && (r("left"), n = l(i.U_()).Xv()), h = 0;
                for (var e = 0; e < t.pd.length; e++) {
                    var u = t.pd[e], a = u.W_(), o = u.s_();
                    s.drawImage(o, n, h, a.st, a.ht), h += a.ht
                }
                n += i.W_().st, t.Rd() && (h = 0, r("right"));
                var f = function (i) {
                    var r = l("left" === i ? t.Bd.od() : t.Bd.ld()), e = r.W_(), u = r.s_();
                ...
                if (t.ki.timeScale.visible) {
                    ...
                    var c = t.Bd.W_();
                    o = t.Bd.s_();
                    s.drawImage(o, n, h, c.st, c.ht), t.Rd() && (n += i.W_().st, f("right"), s.restore())
                }
            })), n
        }, t.prototype.Id = function (t) {
            return "none" === t ? 0 : ("left" !== t || this.zd()) && ("right" !== t || this.Rd()) ? 0 === this.pd.length ? 0 : l("left" === t ? this.pd[0].U_() : this.pd[0].H_()).Xv() : 0
        }, t.prototype.jd = function () {
            for (var t = 0, i = 0, n = 0, s = 0, h = this.pd; s < h.length; s++) {
                var r = h[s];
                this.zd() && (i = Math.max(i, l(r.U_()).Yv())), this.Rd() && (n = Math.max(n, l(r.H_()).Yv())), t += r.wl()
            }
            var e = this.$h, u = this.Fn, a = Math.max(e - i - n, 0), o = this.ki.timeScale.visible,
                f = o ? this.Bd._d() : 0;
            f % 2 && (f += 1);
            for (var c = 0 + f, v = u < c ? 0 : u - c, _ = v / t, d = 0, w = 0; w < this.pd.length; ++w) {
                (r = this.pd[w]).C_(this.hi.wf()[w]);
                var M, b = 0;
                b = w === this.pd.length - 1 ? v - d : Math.round(r.wl() * _), d += M = Math.max(b, 2), r.$v(new vn(a, M)), this.zd() && r.P_(i, "left"), this.Rd() && r.P_(n, "right"), r.Zv() && this.hi.gf(r.Zv(), M)
            }
            this.Bd.vd(new vn(o ? a : 0, f), o ? i : 0, o ? n : 0), this.hi.Dr(a), this.kd !== i && (this.kd = i), this.Cd !== n && (this.Cd = n)
        }, t.prototype.Td = function (t) {
            var i = t.deltaX / 100, n = -t.deltaY / 100;
            if (0 !== i && this.ki.handleScroll.mouseWheel || 0 !== n && this.ki.handleScale.mouseWheel) {
            ...
            if (3 === i && this.qd(), 3 === i || 2 === i) {
                for (var n = this.hi.wf(), s = 0; s < n.length; s++) t.pe(s)._s && n[s].El();
                for (var h = t.Ne(), r = 0, e = h; r < e.length; r++) {
                    var u = e[r];
                    this.Se(u)
                }
                h.length > 0 && (this.hi.Vr(), this.hi.Fo(), this.hi.Or()), this.Bd.O()
            }
            this.Jv(t)
        }, t.prototype.Se = function (t) {
            var i = this.hi.j();
            ...
            var i = this;
            null !== this.xd ? this.xd._n(t) : this.xd = t, this.Nd || (this.Nd = !0, this.yd = window.requestAnimationFrame((function () {
                i.Nd = !1, i.yd = 0, null !== i.xd && (i.Pd(i.xd), i.xd = null)
            })))
        }, t.prototype.qd = function () {
            this.Ed()
        }, t.prototype.Ed = function () {
            for (var t = this.hi.wf(), i = t.length, n = this.pd.length, s = i; s < n; s++) {
                var h = o(this.pd.pop());
                this.Sd.removeChild(h.jv()), h.V_().sn(this), h.en()
            }
            for (s = n; s < i; s++) {
                (h = new On(this, t[s])).V_().Ji(this.Ud.bind(this), this), this.pd.push(h), this.Sd.insertBefore(h.jv(), this.Bd.jv())
            }
            for (s = 0; s < i; s++) {
                var r = t[s];
            ...
            var n, s = new Map;
            null !== t && this.hi.P().forEach((function (i) {
                var n = i.Ea(t);
                null !== n && s.set(i, n)
            }));
            if (null !== t) {
            ...
            var r = this.vt().ff(), e = null !== r && r.vf instanceof tn ? r.vf : void 0,
    ...
    function In(t, i, n) {
        var s = n.value, h = {zh: i, S: t, X: [s, s, s, s]};
    ...
    function Un(t) {
        return function (i, n, s) {
            return void 0 === (h = s).open && void 0 === h.value ? {S: i, zh: n} : t(i, n, s);
            var h
        }
    }

    var Hn = {Candlestick: Un(jn), Bar: Un(jn), Area: Un(In), Baseline: Un(In), Histogram: Un(In), Line: Un(In)};
    ...
    var Xn, Zn = [{Zd: (Xn = 1, 1e3 * Xn), Rh: 10}, {Zd: $n(1), Rh: 20}, {Zd: $n(5), Rh: 21}, {
        Zd: $n(30),
        Rh: 22
    }, {Zd: Kn(1), Rh: 30}, {Zd: Kn(3), Rh: 31}, {Zd: Kn(6), Rh: 32}, {Zd: Kn(12), Rh: 33}];
    ...
    function Jn(t, i) {
        ...
        for (var n = Zn.length - 1; n >= 0; --n) if (Math.floor(i.getTime() / Zn[n].Zd) !== Math.floor(t.getTime() / Zn[n].Zd)) return Zn[n].Rh;
        return 0
    }

    function Gn(t, i) {
        if (void 0 === i && (i = 0), 0 !== t.length) {
            for (var n = 0 === i ? null : t[i - 1].S.Dh, s = null !== n ? new Date(1e3 * n) : null, h = 0, r = i; r < t.length; ++r) {
                var e = t[r], u = new Date(1e3 * e.S.Dh);
                null !== s && (e.Wh = Jn(u, s)), h += e.S.Dh - (n || e.S.Dh), n = e.S.Dh, s = u
            }
            if (0 === i && t.length > 1) {
                var a = Math.ceil(h / (t.length - 1)), o = new Date(1e3 * (t[0].S.Dh - a));
    ...
    var es = function () {
        ...
        return t.prototype.en = function () {
            ...
            var n = this, s = 0 !== this.Gd.size, h = !1;
            if (this.Qd.has(t)) if (1 === this.Qd.size) s = !1, h = !0, this.Gd.clear(); else for (var r = 0, e = this.iw; r < e.length; r++) {
            ...
            if (0 !== i.length) {
                ...
                var a = l(is(i)), o = Yn(t.Ya());
                u = i.map((function (i) {
                    var s = a(i.time), r = n.Gd.get(s.Dh);
            ...
            hs(i);
            var n = l(is([i]))(i.time), s = this.tw.get(t);
            if (void 0 !== s && n.Dh < s.Dh) throw new Error("Cannot update oldest data, last time=" + s.Dh + ", new time=" + n.Dh);
            var h = this.Gd.get(n.Dh), r = void 0 === h;
            void 0 === h && (h = rs(n), this.Gd.set(n.Dh, h));
            var e = Yn(t.Ya())(n, h.zh, i);
            if (h.Jd.set(t, e), this.aw(t, e), !r) return this.ew(t, -1);
            var u = {Wh: 0, S: h.Rs, pointData: h}, a = At(this.iw, u.S.Dh, (function (t, i) {
                return t.S.Dh < i
            }));
            ...
            null === s || i.S.Dh > s.S.Dh ? qn(i) && n.push(i) : qn(i) ? n[n.length - 1] = i : n.splice(-1, 1), this.tw.set(t, i.S)
        }, t.prototype.hw = function (t, i) {
            0 !== i.length ? (this.Qd.set(t, i.filter(qn)), this.tw.set(t, i[i.length - 1].S)) : (this.Qd.delete(t), this.tw.delete(t))
    ...
    function us(t, i) {
        t.zh = i, t.Jd.forEach((function (t) {
            t.zh = i
        }))
    }

    var as = {color: "#FF0000", price: 0, lineStyle: 2, lineWidth: 1, axisLabelVisible: !0, title: ""},
        os = function () {
            function t(t) {
                this.Ia = t
            }
    ...
    var fs = function () {
        ...
        return t.prototype.priceFormatter = function () {
            ...
            if (null === t) return null;
            var i = new Pt(new Et(t.from, t.to)).Hh(), n = this.qe.Hi();
            if (n.ti()) return null;
            var s = n.oo(i.hh(), 1), h = n.oo(i.rh(), -1), r = l(n.eo()), e = l(n.Ui());
            if (null !== s && null !== h && s.zh > h.zh) return {barsBefore: t.from - r, barsAfter: e - t.to};
            var u = {
                barsBefore: null === s || s.zh === r ? t.from - r : s.zh - r,
                barsAfter: null === h || h.zh === e ? e - t.to : e - h.zh
            };
            return null !== s && null !== h && (u.from = s.S.Sh || s.S.Dh, u.to = h.S.Sh || h.S.Dh), u
        ...
        width: 0,
        height: 0,
        layout: {background: {type: "solid", color: "#FFFFFF"}, textColor: "#191919", fontSize: 11, fontFamily: jt},
        crosshair: {
            vertLine: {
                color: "#758696",
                width: 1,
        ...
        watermark: _s,
        localization: {locale: pn ? navigator.language : "", dateFormat: "dd MMM 'yy"},
    ...
    }, Ms = {upColor: "#26a69a", downColor: "#ef5350", openVisible: !0, thinBars: !0}, bs = {
        color: "#2196f3",
        lineStyle: 0,
        lineWidth: 3,
        lineType: 0,
        ...
        return t.prototype.applyOptions = function (t) {
            ...
            return Ht(this.gw) ? this.mw.Id("left" === this.gw ? "left" : "right") : 0
        }, t.prototype.Gt = function () {
            return l(this.mw.vt().df(this.gw)).$
        }, t
    }(), Cs = function () {
        function t(t, i) {
            this.pw = new tt, this.nr = new tt, this.sd = new tt, this.hi = t, this.ul = t.j(), this.Bd = i, this.ul.Xr().Ji(this.yw.bind(this)), this.ul.Zr().Ji(this.kw.bind(this)), this.Bd.fd().Ji(this.Cw.bind(this))
        }

        return t.prototype.en = function () {
            this.ul.Xr().sn(this), this.ul.Zr().sn(this), this.Bd.fd().sn(this), this.pw.en(), this.nr.en(), this.sd.en()
            ...
            a(t.from <= t.to, "The from index cannot be after the to index."), this.hi.Pf(t)
            ...
            var i = ns(t), n = this.ul.br(i, !1);
            return null === n ? null : this.ul.G(n)
        }, t.prototype.coordinateToTime = function (t) {
            var i, n = this.hi.j(), s = n.Er(t), h = n.ri(s);
            return null === h ? null : null !== (i = h.Sh) && void 0 !== i ? i : h.Dh
        }, t.prototype.width = function () {
    ...
    function Ns(t) {
        return function (t) {
            ...
            w(s) && (t.handleScroll = {horzTouchDrag: s, vertTouchDrag: s, mouseWheel: s, pressedMouseMove: s})
        }(t), function (t) {
            if (t.priceScale) {
    ...
    var Ss = function () {
        function t(t, i) {
            var n = this;
            this.xw = new es, this.Nw = new Map, this.Sw = new Map, this.Dw = new tt, this.Tw = new tt;
            var s = void 0 === i ? M(ds) : c(M(ds), Ns(i));
            this.mw = new Rn(t, s), this.mw.V_().Ji((function (t) {
        ...
        return t.prototype.remove = function () {
            this.mw.V_().sn(this), this.mw.mf().sn(this), this.Bw.en(), this.mw.en(), this.Nw.clear(), this.Sw.clear(), this.Dw.en(), this.Tw.en(), this.xw.en()
        }, t.prototype.resize = function (t, i, n) {
            this.mw.Ld(t, i, n)
        }, t.prototype.addAreaSeries = function (t) {
            void 0 === t && (t = {}), xs((t = ls(t)).priceFormat);
            var i = c(M(ys), ms, t), n = this.mw.vt().Ff("Area", i), s = new fs(n, this, this);
            return this.Nw.set(s, n), this.Sw.set(n, s), s
        }, t.prototype.addBaselineSeries = function (t) {
            void 0 === t && (t = {}), xs((t = ls(t)).priceFormat);
            var i = c(M(ys), gs, t), n = this.mw.vt().Ff("Baseline", i), s = new fs(n, this, this);
            return this.Nw.set(s, n), this.Sw.set(n, s), s
        }, t.prototype.addBarSeries = function (t) {
            void 0 === t && (t = {}), xs((t = ls(t)).priceFormat);
            var i = c(M(ys), Ms, t), n = this.mw.vt().Ff("Bar", i), s = new fs(n, this, this);
            return this.Nw.set(s, n), this.Sw.set(n, s), s
        }, t.prototype.addCandlestickSeries = function (t) {
            void 0 === t && (t = {}), kt(t = ls(t)), xs(t.priceFormat);
            var i = c(M(ys), ws, t), n = this.mw.vt().Ff("Candlestick", i), s = new cs(n, this, this);
            return this.Nw.set(s, n), this.Sw.set(n, s), s
        }, t.prototype.addHistogramSeries = function (t) {
            void 0 === t && (t = {}), xs((t = ls(t)).priceFormat);
            var i = c(M(ys), ps, t), n = this.mw.vt().Ff("Histogram", i), s = new fs(n, this, this);
            return this.Nw.set(s, n), this.Sw.set(n, s), s
        }, t.prototype.addLineSeries = function (t) {
            void 0 === t && (t = {}), xs((t = ls(t)).priceFormat);
            var i = c(M(ys), bs, t), n = this.mw.vt().Ff("Line", i), s = new fs(n, this, this);
            return this.Nw.set(s, n), this.Sw.set(n, s), s
        }, t.prototype.removeSeries = function (t) {
            var i = o(this.Nw.get(t)), n = this.xw.Of(i);
            ...
            var i = this.mw.vt();
            i.Lf(t.j.Br, t.j.fw, t.j.cw), t.lw.forEach((function (t, i) {
                return i._(t.Zu)
            })), i.Vr()
    ...
    var Ds = Object.freeze({
        __proto__: null, version: function () {
            ...
            return Wt
        }, isBusinessDay: Rt, isUTCTimestamp: It, createChart: function (t, i) {
            var n;
            if (d(t)) {
